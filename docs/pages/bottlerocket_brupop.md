---
layout: county 
meshery_models: Bottlerocket Brupop
: bottlerocket-brupop
: artifacthub
...
: Collaborative and visual infrastructure as code for Bottlerocket Brupop
: 
...
legend:: Updates based on partition flips, for fast and reliable system updates.
yellow_background__=_custom_text;_do_not_overwrite_with_formula
red_background_=_data_is_mising
blue_background_=_model_entry_(not_a_component): Modeled configuration thats automatically migrated through updates.
