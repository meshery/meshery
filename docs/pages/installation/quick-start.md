...
{% include alert.html type="info" title="Kubeconfig Permissions" content="Ensure your kubeconfig has the necessary permissions for Meshery to connect and manage your cluster. At minimum, Meshery requires read access to the <code>kube-system</code> namespace. See the <a href='/reference/kubernetes-cluster-permissions'>Kubernetes Cluster Permissions</a> reference for complete details." %}
