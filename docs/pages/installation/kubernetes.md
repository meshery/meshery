...
<div class="prereqs"><h4>Prerequisites</h4>
  <ol>
    ...
    <li>Access to an active kubernetes cluster with appropriate <a href="{{ site.baseurl }}/guides/infrastructure-management/kubernetes-cluster-permissions">kubeconfig permissions</a>.</li>
  </ol>
</div>
