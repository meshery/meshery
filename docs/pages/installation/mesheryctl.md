...
{% include alert.html type="info" title="NOTE" content="By default, the mesheryctl platform is set to Kubernetes. If you are using any other platform, please use the -p flag." %}
