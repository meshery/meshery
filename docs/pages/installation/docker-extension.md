...
<pre class="codeblock-pre" style="padding: 0; margin: 0;">
    <div class="codeblock" style="display: inline-block; font-size: 0;">
        ...
        <div class="window-buttons" style="font-size: 0;"></div>
        <div id="termynal2" style="width:100%; height:200px; max-width:100%; font-size: 0;" data-termynal="">
            <span data-ty="input" style="font-size: 0;">docker extension install meshery/docker-extension-meshery</span>
            <span data-ty="progress" style="font-size: 0;"></span>
            <span data-ty="" style="font-size: 0;">Successfully installed Meshery</span>
            <span data-ty="input" style="font-size: 0;">mesheryctl system dashboard</span>
        </div>
    </div>
</pre>
