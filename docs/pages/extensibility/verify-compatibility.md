...
type: Extensibility
abstract: "A guide for Meshery extension developers on maintaining compatibility with the Meshery platform, covering shared frameworks, dependencies, and build tooling."
language: en
list: include
---
...
{% include alert.html type="info" title="Meshery's Bill of Materials" content="Meshery's version is defined by its <a href='https://docs.meshery.io/project/contributing#meshery-contribution-flow'>Bill of Materials (BOM)</a>, which specifies versions for Go, Node.js, and other key dependencies. Extension developers should reference the BOM to ensure alignment." %}
