...
: Collaborative and visual infrastructure as code for Dast Operator
: 
...
legend:: Scan external URL defined in custom. resource
yellow_background__=_custom_text;_do_not_overwrite_with_formula
red_background_=_data_is_mising
blue_background_=_model_entry_(not_a_component): Scan internal services based on its annotations.
