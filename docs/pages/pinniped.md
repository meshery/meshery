...
2: FALSE
: 
layer5_integration_pages: Pinniped is the easy, secure way to log in to your Kubernetes clusters.
: Collaborative and visual infrastructure as code for Pinniped
: 
