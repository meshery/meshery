...
<details close><summary>Visual Representation of Tag-Sets Relationship</summary>
           <figure><br><figcaption>Tag-Set: my-nodepart (Tag) and my-sample-app (Set)</a></figcaption>
           <img alt="Tag-Sets Relationships" src="{{ site.baseurl }}/assets/img/meshmodel/relationships/tagset_relationship.svg"/>
           </figure>
   </details>
