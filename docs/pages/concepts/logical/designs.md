...
When creating a new design, by default its visibility level will be set to **public**. [Remote Providers](/extensibility/providers) have the option of offering additional visibility levels like **private** and **published**.
