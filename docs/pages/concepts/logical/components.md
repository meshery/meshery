...
- **Status**: The current state of the component (for semantic components). Status reflects the real-time operational state and is managed through Connections to your infrastructure.
