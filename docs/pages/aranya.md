...
: Collaborative and visual infrastructure as code for Aranya
: 
...
legend:: Deploy and manage large scale devices with kubectl (Kubernetes API) and ansible.
yellow_background__=_custom_text;_do_not_overwrite_with_formula
red_background_=_data_is_mising
blue_background_=_model_entry_(not_a_component): Single custom resource to rule all kinds of devices and workloads.
