...
---
%!(EXTRA string=Spinnaker is an open source, multi-cloud continuous delivery platform for releasing software changes with high velocity and confidence., string=<p>
