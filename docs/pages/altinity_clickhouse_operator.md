---
layout: county 
meshery_models: Altinity Clickhouse Operator
...
: Collaborative and visual infrastructure as code for Altinity Clickhouse Operator
: 
...
legend:: Customize storage provisioning (VolumeClaim templates)
yellow_background__=_custom_text;_do_not_overwrite_with_formula
red_background_=_data_is_mising
blue_background_=_model_entry_(not_a_component): Customize pod templates
