...
<ol>
  ...
  <li><strong>Familiarize</strong> yourself with the broader set of projects in Meshery's ecosystem, including the [meshery-extensions](https://github.com/meshery-extensions) repositories (this <a href="https://layer5.io/community/handbook/repository-overview">Repository Overview</a> is a helpful resource): Spend time understanding each of the initiatives through high-level overviews available in the community drive and through discussions with your MeshMate.</li>
