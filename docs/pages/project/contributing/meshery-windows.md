...
This approach can be the most challenging to setup among all and is recommended for users that are very coversant with setting up development environments in Windows.
...
Visit [https://go.dev/doc/install](https://go.dev/doc/install) to download and install Go. As of this writing, Meshery uses **1.25.5**. The path is usually automatically added.

#### - Git Bash

Git Bash is a terminal emulator which provides git command line experience along with Linux-like command line experience. Download it from : https://git-scm.com/downloads
...
<a href="{{ site.baseurl }}/assets/img/contributing/win-environment-variables.png">
  <img style= "max-width: 450px;" src="{{ site.baseurl }}/assets/img/contributing/win-environment-variables.png" />
</a>

You are now ready to [contribute](https://docs.meshery.io/project/contributing/) to Meshery.
