  ...
  <section class="tabbed">
    ...
    <div class="tab-container">
      ...
      <section class="tabbed">
        ...
        <h4>2. Configure Model Details</h4>
        ...
        <h4>3. Set Model Categorization</h4>
        ...
        <h4>4. Configure Model Styling</h4>
        ...
        <h4>5. Provide Source Location</h4>
        ...
        <h4>7. Finalize and Generate</h4>
        <p>Review your model details. If everything looks good, click "Generate" to create your model.</p>
        <p>Meshery will process the provided source URL, extract the necessary information, and generate the model based on the specified details.</p>
        ...
        <h4>8. Model Generation Status</h4>
        <p>Once the model generation is complete, you will see a confirmation message indicating that your model has been successfully created.</p>
        <p>You can also view all of the components and relationships that were created during the generation process.</p>
        <p>If model generation was unsuccessful, you will see an error message indicating the reason for the failure. You can then go back and make any necessary changes to your model details or source URL.</p>
