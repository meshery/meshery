...
## Guide for setting Meshery Development Environment on Windows

Here is a link to setting up: [https://docs.meshery.io/project/contributing/meshery-windows](https://docs.meshery.io/project/contributing/meshery-windows)
