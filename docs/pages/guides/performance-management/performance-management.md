...
Meshery also comes with a set of [sample applications](h{{ site.baseurl }}/guides/infrastructure-management/sample-apps) that you can quickly deploy to test out the capabilities of your cloud native infrastructure.
