...
Meshery's sample application [ImageHub](/docs/pages/guides/infrastructure-management/deploying-sample-apps.md) will let you test out configuring these filters out-of-the-box.
...
Meshery has a set of [sample applications](/docs/pages/guides/infrastructure-management/deploying-sample-apps.md) which you can use to quickly test out your deployment.
...
You can also run the same application on multiple connected kubernetes clusters and compare the performance. See [Performance Management with Meshery](/docs/pages/guides/performance-management/performance-management.md) for more details.
