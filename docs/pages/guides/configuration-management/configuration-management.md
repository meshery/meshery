...
Meshery's sample application [ImageHub]({{ site.baseurl }}/pages/guides/infrastructure-management/deploying-sample-apps) will let you test out configuring these filters out-of-the-box.
...
Meshery has a set of [sample applications]({{ site.baseurl }}/pages/guides/infrastructure-management/deploying-sample-apps) which you can use to quickly test out your deployment.
...
You can also run the same application on multiple connected kubernetes clusters and compare the performance. See [Performance Management with Meshery]({{ site.baseurl }}/pages/guides/performance-management/performance-management) for more details.
