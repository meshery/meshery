---
layout: default
title: "Genişletilebilirlik: Yük Oluşturucular"
permalink: tr/extensibility/load-generators
type: Reference
#redirect_from: architecture/adapters
abstract: "Meshery, dünyadaki diğer tüm proje veya ürünlerden daha fazla adaptör desteği sunar. Meshery, çeşitli hizmet ağlarını yönetmek için bağdaştırıcılar kullanır."
language: tr
lang: tr
categories: tr
list: include
