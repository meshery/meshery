---
layout: default
title: Meshery'de Metrikleri Kullanma
description: Meshery'de Prometheus ve Grafana ölçümleri nasıl bağlanır ve kullanılır
permalink: tr/guides/meshery-metrics
language: tr
lang: tr
categories: tr
type: Guides
