---
layout: default
title: Örnek Uygulamaları Dağıtma
description: Bu kılavuz, kullanıcıların örnek uygulamaları daha iyi anlamalarına yardımcı olmak içindir
permalink: tr/guides/sample-apps
language: tr
lang: tr
categories: tr
type: Guides
