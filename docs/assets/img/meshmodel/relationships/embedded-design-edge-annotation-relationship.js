...
const data = {
  elements: {
    nodes: [
      {
        data: {
          id: "36f27f24-c483-4a34-b123-ef56db24b54d",
          label: "",
          schemaId: "components.meshery.io/v1beta1",
          badges: {
            "text-box-content": {
              id: "text-box-content",
              $componentId: "36f27f24-c483-4a34-b123-ef56db24b54d",
              pos: { valign: "center", halign: "center" },
              html: "",
            },
          },
        },
        position: { x: 438.6133267488344, y: 264.4906769015144 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
        ...
        grabbable: true,
        pannable: false,
        classes: "cdnd-grabbed-node",
      },
      {
        data: {
          id: "f6d383e6-99d6-44c8-8b63-1e39d87f882d",
          label: "",
          schemaId: "components.meshery.io/v1beta1",
          badges: {
            "text-box-content": {
              id: "text-box-content",
              $componentId: "f6d383e6-99d6-44c8-8b63-1e39d87f882d",
              pos: { valign: "center", halign: "center" },
              html: "",
            },
          },
        },
        position: { x: 578.8379005978576, y: 170.88305626003907 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "3fcd7b19-39f4-4c7d-bf98-79d035d3d5f0",
          label: "",
          schemaId: "components.meshery.io/v1beta1",
          badges: {
            "text-box-content": {
              id: "text-box-content",
              $componentId: "3fcd7b19-39f4-4c7d-bf98-79d035d3d5f0",
              pos: { valign: "center", halign: "center" },
              html: "",
            },
          },
        },
        position: { x: 629.1120155011564, y: 316.42188690740056 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
    ...
    edges: [
      {
        data: {
          id: "98b88e35-31f3-4b1b-a9ee-81247d852a1d",
          source: "f6d383e6-99d6-44c8-8b63-1e39d87f882d",
          target: "36f27f24-c483-4a34-b123-ef56db24b54d",
        },
        position: { x: 40.546665284370235, y: -15.780398992767974 },
        group: "edges",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "720f9764-2135-407c-9cff-8ff454c6a9ba",
          source: "36f27f24-c483-4a34-b123-ef56db24b54d",
          target: "3fcd7b19-39f4-4c7d-bf98-79d035d3d5f0",
        },
        position: { x: 45.604971279946426, y: 35.981064998732194 },
        group: "edges",
        removed: false,
        selected: false,
        selectable: true,
  ...
  elementStyles: {
    "36f27f24-c483-4a34-b123-ef56db24b54d": {
      events: "yes",
      "text-events": "no",
      textEvents: "no",
      ...
      "background-color": "rgb(231,21,123)",
      backgroundColor: "rgb(231,21,123)",
    ...
    "f6d383e6-99d6-44c8-8b63-1e39d87f882d": {
      events: "yes",
      "text-events": "no",
      textEvents: "no",
      "transition-property": "none",
      ...
      "shape-polygon-points": "-1 -1 1 -1 1 1 -1 1",
      shapePolygonPoints: "-1 -1 1 -1 1 1 -1 1",
      "background-color": "rgb(201,37,209)",
      backgroundColor: "rgb(201,37,209)",
      "background-fill": "solid",
      backgroundFill: "solid",
      "background-opacity": "1",
      backgroundOpacity: "1",
    ...
    "3fcd7b19-39f4-4c7d-bf98-79d035d3d5f0": {
      events: "yes",
      "text-events": "no",
      textEvents: "no",
      "transition-property": "none",
      ...
      "shape-polygon-points": "-1 -1 1 -1 1 1 -1 1",
      shapePolygonPoints: "-1 -1 1 -1 1 1 -1 1",
      "background-color": "rgb(221,52,76)",
      backgroundColor: "rgb(221,52,76)",
      "background-fill": "solid",
      backgroundFill: "solid",
      "background-opacity": "1",
      backgroundOpacity: "1",
    ...
    "98b88e35-31f3-4b1b-a9ee-81247d852a1d": {
      events: "yes",
      "text-events": "yes",
      textEvents: "yes",
      "transition-property": "none",
      ...
      "line-style": "solid",
      lineStyle: "solid",
      "line-color": "rgb(0,179,159)",
      lineColor: "rgb(0,179,159)",
      "line-fill": "solid",
      lineFill: "solid",
      "line-cap": "butt",
      lineCap: "butt",
      ...
      "mid-source-arrow-color": "rgb(153,153,153)",
      midSourceArrowColor: "rgb(153,153,153)",
      "target-arrow-color": "rgb(0,179,159)",
      targetArrowColor: "rgb(0,179,159)",
      "mid-target-arrow-color": "rgb(153,153,153)",
      midTargetArrowColor: "rgb(153,153,153)",
      "source-arrow-fill": "filled",
      sourceArrowFill: "filled",
    ...
    "720f9764-2135-407c-9cff-8ff454c6a9ba": {
      events: "yes",
      "text-events": "yes",
      textEvents: "yes",
      "transition-property": "none",
...
const CreateToolBar = () => {
  const cyContainer = document.getElementById(
    "embedded-design-daecd14f-6c65-45d9-b74a-4fc536a7868f",
  );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var cy = (window.cy = cytoscape({
    container: document.getElementById(
      "embedded-design-daecd14f-6c65-45d9-b74a-4fc536a7868f-cy",
    ),
