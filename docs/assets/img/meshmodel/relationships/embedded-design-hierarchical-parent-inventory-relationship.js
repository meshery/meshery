...
const data = {
  elements: {
    nodes: [
      {
        data: {
          id: "b841e1e1-9794-434a-9b2a-19e2232f01ff",
          label: "config-map-re",
          schemaId: "components.meshery.io/v1beta1",
          parent: "a9a2fdb6-dfef-4f48-b600-7a403703eccd",
        },
        position: { x: 546.4209269116215, y: 432.47542067969164 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "2527013e-77df-49cc-a321-a044c902118c",
          label: "role-bg",
          schemaId: "components.meshery.io/v1beta1",
          parent: "a9a2fdb6-dfef-4f48-b600-7a403703eccd",
        },
        position: { x: 669.3588338805155, y: 415.2586110872295 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "a9a2fdb6-dfef-4f48-b600-7a403703eccd",
          label: "namespace",
          schemaId: "components.meshery.io/v1beta1",
          badges: {
            compoundNodeBadge: {
              $componentId: "a9a2fdb6-dfef-4f48-b600-7a403703eccd",
              id: "compoundNodeBadge",
              html: '<span\n         id="a9a2fdb6-dfef-4f48-b600-7a403703eccd-compoundNodeBadge"\n         style="width:5rem;height:5rem;border-radius:50%;font-size:2rem;color:white;display:flex;justify-content:center;align-items:center;background-color:#D43800;z-index:101;user-select:none;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;position:relative;background:url(https://playground.meshery.io/ui/public/static/img/meshmodels/kubernetes/white/namespace-white.svg),#326CE5;background-size:3rem;background-repeat:no-repeat;background-position:center;transform:translate(-5rem, -7rem)"\n         >\n         \n       </span>',
              pos: { halign: "left", valign: "bottom" },
            },
          },
        },
        position: { x: 601.6398803960685, y: 433.36701588346057 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
  ...
  elementStyles: {
    "b841e1e1-9794-434a-9b2a-19e2232f01ff": {
      events: "yes",
      "text-events": "no",
      textEvents: "no",
    ...
    "2527013e-77df-49cc-a321-a044c902118c": {
      events: "yes",
      "text-events": "no",
      textEvents: "no",
      "transition-property": "none",
    ...
    "a9a2fdb6-dfef-4f48-b600-7a403703eccd": {
      events: "yes",
      "text-events": "no",
      textEvents: "no",
      "transition-property": "none",
...
const addStyles = () => {
  var css = ` 
    ...
    #embedded-design-ccf38fba-6ada-4332-8ee7-033ee2c21f91 .embed-canvas-container {
        height: 100%;
        width: 100%;
        background-color: "inheirt";
    }
   #embedded-design-ccf38fba-6ada-4332-8ee7-033ee2c21f91 .water-mark{
    ...
    #embedded-design-ccf38fba-6ada-4332-8ee7-033ee2c21f91 .toolbar {
...
const CreateToolBar = () => {
  const cyContainer = document.getElementById(
    "embedded-design-ccf38fba-6ada-4332-8ee7-033ee2c21f91",
  );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  cyContainer.id = "embedded-design-ccf38fba-6ada-4332-8ee7-033ee2c21f91-cy";
  ...
  var cy = (window.cy = cytoscape({
    container: document.getElementById(
      "embedded-design-ccf38fba-6ada-4332-8ee7-033ee2c21f91-cy",
    ),
