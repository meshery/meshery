...
const data = {
  elements: {
    nodes: [
      {
        data: {
          id: "3b11e6af-7270-4a99-864c-488957f955c8",
          label: "Service Account",
          schemaId: "components.meshery.io/v1beta1",
        },
        position: { x: -738.039679515531, y: 189.94957793073016 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "0d4f1419-924c-4a6e-98da-eaf082f73b94",
          label: "Role",
          schemaId: "components.meshery.io/v1beta1",
        },
        position: { x: -274.0184122444665, y: 210.79000403252786 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "bc00f82e-6b2b-4ab1-aae0-ee71caf4ce47",
          label: "Cluster Role",
          schemaId: "components.meshery.io/v1beta1",
        },
        position: { x: -397.7575151223609, y: -79.2696269360955 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "f13644bb-d4cb-4284-b8bb-0101994e152d",
          label: "cluster-role-binding-sv",
          schemaId: "components.meshery.io/v1beta1",
          type: "bindingNode",
        },
        position: { x: -567.0517289980392, y: 54.66996325501247 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "b08a4cba-a089-4f3b-b914-39bf3acfb6c3",
          label: "role-binding-as",
          schemaId: "components.meshery.io/v1beta1",
          type: "bindingNode",
        },
        position: { x: -505.1356924059065, y: 200.4099138561022 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
    ...
    edges: [
      {
        data: {
          id: "7575947f-918c-4ff6-8129-18c3dd46e12c",
          source: "bc00f82e-6b2b-4ab1-aae0-ee71caf4ce47",
          target: "3b11e6af-7270-4a99-864c-488957f955c8",
        },
        position: { x: 42.93289875180133, y: 31.62076299624932 },
        group: "edges",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "61530acd-b4f7-4770-b8dc-4ad88c5bf181",
          source: "0d4f1419-924c-4a6e-98da-eaf082f73b94",
          target: "3b11e6af-7270-4a99-864c-488957f955c8",
        },
        position: { x: 23.867028952209868, y: 40.16340427239091 },
        group: "edges",
        removed: false,
        selected: false,
        selectable: true,
  ...
  elementStyles: {
    "3b11e6af-7270-4a99-864c-488957f955c8": {
      events: "yes",
      "text-events": "no",
      textEvents: "no",
    ...
    "0d4f1419-924c-4a6e-98da-eaf082f73b94": {
      events: "yes",
      "text-events": "no",
      textEvents: "no",
      "transition-property": "none",
    ...
    "bc00f82e-6b2b-4ab1-aae0-ee71caf4ce47": {
      events: "yes",
      "text-events": "no",
      textEvents: "no",
      "transition-property": "none",
    ...
    "f13644bb-d4cb-4284-b8bb-0101994e152d": {
      events: "yes",
      "text-events": "no",
      textEvents: "no",
      "transition-property": "none",
      ...
      "outside-texture-bg-opacity": "0.125",
      outsideTextureBgOpacity: "0.125",
      content: "cluster-role-binding-sv",
      "control-point-weight": "0.5",
      controlPointWeight: "0.5",
      "edge-text-rotation": "none",
      edgeTextRotation: "none",
    ...
    "b08a4cba-a089-4f3b-b914-39bf3acfb6c3": {
      events: "yes",
      "text-events": "no",
      textEvents: "no",
      "transition-property": "none",
    ...
    "7575947f-918c-4ff6-8129-18c3dd46e12c": {
      events: "yes",
      "text-events": "yes",
      textEvents: "yes",
      "transition-property": "none",
      ...
      "mid-target-arrow-shape": "none",
      midTargetArrowShape: "none",
      "source-arrow-color": "rgb(147,152,176)",
      sourceArrowColor: "rgb(147,152,176)",
      "mid-source-arrow-color": "rgb(153,153,153)",
      midSourceArrowColor: "rgb(153,153,153)",
      "target-arrow-color": "rgb(147,152,176)",
      targetArrowColor: "rgb(147,152,176)",
      "mid-target-arrow-color": "rgb(153,153,153)",
      midTargetArrowColor: "rgb(153,153,153)",
      "source-arrow-fill": "filled",
      sourceArrowFill: "filled",
    ...
    "61530acd-b4f7-4770-b8dc-4ad88c5bf181": {
      events: "yes",
      "text-events": "yes",
      textEvents: "yes",
      "transition-property": "none",
...
const addStyles = () => {
  var css = ` 
    ...
    #embedded-design-a7b22d89-41bc-4379-a983-20e835341faf .embed-canvas-container {
        height: 100%;
        width: 100%;
        background-color: "inheirt";
    }
   #embedded-design-a7b22d89-41bc-4379-a983-20e835341faf .water-mark{
    ...
    #embedded-design-a7b22d89-41bc-4379-a983-20e835341faf .toolbar {
...
const CreateToolBar = () => {
  const cyContainer = document.getElementById(
    "embedded-design-a7b22d89-41bc-4379-a983-20e835341faf",
  );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  cyContainer.id = "embedded-design-a7b22d89-41bc-4379-a983-20e835341faf-cy";
  ...
  var cy = (window.cy = cytoscape({
    container: document.getElementById(
      "embedded-design-a7b22d89-41bc-4379-a983-20e835341faf-cy",
    ),
