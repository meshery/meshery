...
{{< code code=`var linkDocPatternApply = map[string]string{
	"link":    "![pattern-apply-usage]({{< relurl "reference/reference/images/patternApply.png" >}})",
