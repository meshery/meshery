...
| `guide_assets_folder` | Yes | — | Folder name under `images/`. Lowercased before use, producing `images/<folder>/<filename>`. The misspelled `guide_assests_folder` is still accepted for backward compatibility. |
