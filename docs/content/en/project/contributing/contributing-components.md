...
{{% alert color="warning" title="Prerequisite Reading" %}}Components are defined and packaged in context of a Model. Be sure to first read and understand <a href='{{< ref "project/contributing/contributing-models/index.md" >}}'>how models are created and packaged</a> before attempting to create a new component. Without a model defined first, they component will be homeless.{{% /alert %}}
