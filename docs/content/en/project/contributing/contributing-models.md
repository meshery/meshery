...
- **[Components]({{< ref "concepts/logical/components/index.md" >}})**: Individual parts of a system (e.g., services, databases).
...
> See [Registry]({{< ref "concepts/logical/registry/index.md" >}}) to learn more about Meshery's internal registry and how to use it.

[![Model Entity Classification]({{< relurl "project/contributing/images/meshmodel-architecture.svg" >}})]({{< relurl "project/contributing/images/meshery-models.png" >}})
...
4. **Registration**: Components are registered in Meshery's [Registry]({{< ref "concepts/logical/registry/index.md" >}}) under their respective model.
