...
| --- | --- | --- | --- | --- |
| [`mesheryctl`]({{< ref "installation/mesheryctl.md" >}}) only | macOS, Linux, Windows | `mesheryctl` installed via Bash, Homebrew, Scoop, or direct download | No | Installing, upgrading, and managing Meshery deployments |
