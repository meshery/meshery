...
As of this writing, you will be presented with at least two providers, one remote provider and one local provider: _Meshery_ and _None_, respectively.
...
- Selecting _Meshery_ will open a browser to complete the login and authentication process with community-supported Meshery Cloud. On successful authentication, you can close the window and return to the command prompt. 
