...
<a href="images/system-dashboard.png"><img alt="skip-browser" style="width:500px;height:auto;" src="images/system-dashboard.png" /></a>
...
<a href="images/provider-switch.png"><img alt="skip-browser" style="width:500px;height:auto;" src="images/provider-switch.png" /></a>

### list
`mesheryctl system provider list` : Lists all available providers

<a href="images/provider-list.png"><img alt="skip-browser" style="width:500px;height:auto;" src="images/provider-list.png" /></a>

### set
`mesheryctl system provider set` : Set your provider

<a href="images/provider-set.png"><img alt="skip-browser" style="width:500px;height:auto;" src="images/provider-set.png" /></a>

### view
`mesheryctl system provider view` : Lists your current context and provider

<a href="images/provider-view.png"><img alt="skip-browser" style="width:500px;height:auto;" src="images/provider-view.png" /></a>
