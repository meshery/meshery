...
In Meshery, the line that connects [components]({{< ref "concepts/logical/components.md" >}}) is called an **edge**. Each edge visually represents a [relationship]({{< ref "concepts/logical/relationships/index.md" >}}) and uses a specific style to communicate its nature.
