...
![Kubernetes components in Meshery](./images/k8s_component.gif)
...
![AWS models in Meshery](./images/AWS-models.png)
...
![Generic shapes palette in Meshery](./images/shapes.png)
...
![Deployment Component Shape](./images/deployment-shape.png)
