...
See [mesheryctl design subcommand section]({{< ref "reference/reference/mesheryctl/_index.md#cloud-native-pattern-configuration-and-management" >}}) for more details on the `design` subcommand.
