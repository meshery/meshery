...
See [Creating a Meshery Design]({{< ref "guides/configuration-management/creating-a-meshery-design/index.md" >}}) for a step-by-step walkthrough. Use Meshery UI or `mesheryctl` to create and manage designs.
