...
![Registry generate model](./images/create-ui-where.gif)
...
![Registry generate model name](./images/create-ui-name.png)
...
![Registry generate model categorization](./images/create-ui-category.png)
...
![Registry generate model styling](./images/create-ui-styling.png)
...
![Registry generate model source selection](./images/create-ui-source.png)
...
![Registry generate model additional settings](./images/create-ui-details.png)
...
![Registry generate model finalize](./images/create-ui-finalize.png)
...
<!-- tab -->
Using Integration Spreadsheet | fa fa-table
