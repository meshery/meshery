...
Before you can use the Meshery CLI to export a [Model](/concepts/logical/models), you must first install it. You can install Meshery CLI by [following the instructions](/installation#install-mesheryctl).
