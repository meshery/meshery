...
See the [`mesheryctl design` reference]({{< ref "reference/reference/mesheryctl/design/_index.md" >}}) for the full subcommand reference.
...
- [`mesheryctl design` reference]({{< ref "reference/reference/mesheryctl/design/_index.md" >}})
