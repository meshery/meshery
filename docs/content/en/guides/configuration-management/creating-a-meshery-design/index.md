...
<img src="../working-with-designs/images/meshery-patterns.png" width="60%" alt="Seed designs in Meshery UI" />

You can also import community designs from the [Meshery Catalog](https://meshery.io/catalog) or from a Git repository.

<img src="../working-with-designs/images/pattern-import.png" width="60%" alt="Importing a design in Meshery UI" />
