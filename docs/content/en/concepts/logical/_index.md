...
3. Composable (see [Patterns]({{< ref "concepts/logical/patterns/index.md" >}}))
4. Portable (see Export/Import of [Designs]({{< ref "concepts/logical/designs/index.md" >}}) and [Models]({{< ref "concepts/logical/models/index.md" >}}))
