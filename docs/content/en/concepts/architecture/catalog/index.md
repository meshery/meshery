...
5. [Importing]({{< ref "reference/reference/mesheryctl/_index.md#cloud-native-pattern-configuration-and-management" >}}) a design. `mesheryctl design import -f [file-path] -s [manifest | compose | helm]`
