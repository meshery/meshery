...
- name: tcp-route
  ...
  description: 
- name: rate-limit
  colorIcon: extensions/models/consul/components/rate-limit/icons/color/rate-limit-color.svg
  whiteIcon: extensions/models/consul/components/rate-limit/icons/white/rate-limit-white.svg
  description: 
- name: route-tlssds-filter
  colorIcon: extensions/models/consul/components/route-tlssds-filter/icons/color/route-tlssds-filter-color.svg
  whiteIcon: extensions/models/consul/components/route-tlssds-filter/icons/white/route-tlssds-filter-white.svg
  description: 
- name: route-tlssds-filter
  colorIcon: extensions/models/consul/components/route-tlssds-filter/icons/color/route-tlssds-filter-color.svg
  whiteIcon: extensions/models/consul/components/route-tlssds-filter/icons/white/route-tlssds-filter-white.svg
