...
- name: egress-only-internet-gateway
  colorIcon: extensions/models/aws-ec2-controller/components/egress-only-internet-gateway/icons/color/egress-only-internet-gateway-color.svg
  whiteIcon: extensions/models/aws-ec2-controller/components/egress-only-internet-gateway/icons/white/egress-only-internet-gateway-white.svg
  description: 
- name: egress-only-internet-gateway
  colorIcon: extensions/models/aws-ec2-controller/components/egress-only-internet-gateway/icons/color/egress-only-internet-gateway-color.svg
  whiteIcon: extensions/models/aws-ec2-controller/components/egress-only-internet-gateway/icons/white/egress-only-internet-gateway-white.svg
