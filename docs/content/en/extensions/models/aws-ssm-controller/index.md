...
- name: iam-role-selector
  ...
  description: 
- name: parameter
  colorIcon: extensions/models/aws-ssm-controller/components/parameter/icons/color/parameter-color.svg
  whiteIcon: extensions/models/aws-ssm-controller/components/parameter/icons/white/parameter-white.svg
  description: 
components-count: 8
relationships: 
- type: "non-binding"
