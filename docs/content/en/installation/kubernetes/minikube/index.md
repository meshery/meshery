...
For detailed instructions on port forwarding, refer to the [port-forwarding]({{< ref "reference/reference/mesheryctl/system/dashboard.md" >}}) guide.
...
Verify the health of your Meshery deployment, using <a href='{{< ref "reference/reference/mesheryctl/system/check.md" >}}'>mesheryctl system check</a>.
