...
display_title: false
image: installation/kubernetes/gke/images/gke.png
...
1. If you are using port-forwarding, please refer to the [port-forwarding]({{< ref "reference/reference/mesheryctl/system/dashboard.md" >}}) guide for detailed instructions.
