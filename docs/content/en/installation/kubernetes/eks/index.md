...
display_title: false
image: installation/kubernetes/eks/images/eks.png
...
Execute <a href='{{< ref "reference/references/mesheryctl/system/start.md" >}}'>mesheryctl system start</a> command to start Meshery.
