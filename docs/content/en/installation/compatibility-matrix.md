    ...
    <ul class="nav nav-tabs nav-fill mb-3" id="myTab" role="tablist">
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
              <td><a href="/installation/docker-extension">Docker Desktop<br></a><span style="color:#999999; text-decororation:none;"><em>Used through <b>Docker Extension</b></em></span></td>
        ...
        <div style="text-align:center;" class="tab-pane fade" id="windows" role="tabpanel" aria-labelledby="windows-tab">
          ...
          <table class="table table-striped table-bordered">
            ...
            <tr>
              <td><a href="/installation/windows#wsl1">WSL1</a></td>
              <td><b>x64</b> - Windows 7 </td>
            </tr>
            <tr>
              <td><a href="/installation/windows#wsl1">WSL2</a></td>
...
<div style="z-index:0">
  {{% alert color="info" title="<span style='margin:0;'>Overview of the Integration Tests</span>" %}}
