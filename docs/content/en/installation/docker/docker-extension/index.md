...
<h1>Quick Start with Docker Extension <img src='{{< static "installation/docker/images/docker.svg" >}}' style="width:35px;height:35px;" /></h1>
...
- This document applies only when Docker Desktop uses kubeadm with Kubernetes enabled. If you are using kind, please refer to the [Kind]({{< ref "installation/kubernetes/kinD/index.md" >}}) section.
...
<a href="{{ 'assets/img/platforms/docker-desktop-meshery-extension-install.png' | relURL }}"><img src="{{ 'assets/img/platforms/docker-desktop-meshery-extension-install.png' | relURL }}" alt="Docker Meshery Extension Install" /></a>
...
<a href='{{< static "installation/docker/images/docker-desktop-meshery-extension-remove.png" >}}'><img src='{{< static "installation/docker/images/docker-desktop-meshery-extension-remove.png" >}}' alt="Remove Meshery Docker Desktop Extension" /></a>
