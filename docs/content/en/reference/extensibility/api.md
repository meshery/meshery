...
See [REST API Reference]({{< ref "reference/reference/rest-apis/_index.md" >}}) Self-generated API documentation for Meshery's REST API. Documentation is generated from Meshery's Open API schema.
{{% /alert %}}
...
See [GraphQL API Reference]({{< ref "reference/reference/graphql-apis.md" >}}) Self-generated API documentation for Meshery's GraphQL API. The API can be explored interactively using the GraphQL Playground. Documentation is generated from Meshery's GraphQL schema. Each table below documents a GraphQL type.
{{% /alert %}}
{{< /tabs >}}
...
Meshery authentication tokens allow users or systems to authenticate with Meshery Server via either its two clients, [Meshery CLI]({{< ref "reference/reference/mesheryctl/_index.md" >}}) and [UI](#how-to-get-your-token), or its two APIs: [REST]({{< ref "reference/reference/rest-apis/_index.md" >}}) or [GraphQL]({{< ref "reference/reference/graphql-apis.md" >}}). 
