...
<details>
  ...
  <br />
Using <a href='{{< ref "reference/references/mesheryctl/_index.md" >}}'>Meshery CLI</a>, you can get a copy of your authentication token by executing the following command:
  <br/>
  <br/>
