...
image: /v0.5/assets/img/service-meshes/octarine.svg
...
<a href="{{ site.baseurl }}/v0.5/assets/img/adapters/octarine/octarine-adapter.png">
  <img style="width:500px;" src="{{ site.baseurl }}/v0.5/assets/img/adapters/octarine/octarine-adapter.png" />
</a>

##### **Click on (+) and choose the {{page.version}} of the {{page.mesh_name}} service mesh.**

<a href="{{ site.baseurl }}/v0.5/assets/img/adapters/octarine/octarine-install.png">
  <img style="width:500px;" src="{{ site.baseurl }}/v0.5/assets/img/adapters/octarine/octarine-install.png" />
</a>
