...
image: /v0.3/assets/img/service-meshes/linkerd.svg
...
<a href="{{ site.baseurl }}/v0.3/assets/img/adapters/linkerd/linkerd-adapter.png">
  <img style="width:500px;" src="{{ site.baseurl }}/v0.3/assets/img/adapters/linkerd/linkerd-adapter.png" />
</a>

##### Click on (+) and choose the {{page.version}} of the {{page.mesh_name}} service mesh.

<a href="{{ site.baseurl }}/v0.3/assets/img/adapters/linkerd/linkerd-install.png">
  <img style="width:500px;" src="{{ site.baseurl }}/v0.3/assets/img/adapters/linkerd/linkerd-install.png" />
</a>
