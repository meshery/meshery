...
- name: spanner-instance
  ...
  description: 
- name: sql-database
  colorIcon: assets/img/integrations/k8s-config-connector/components/sql-database/icons/color/sql-database-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/sql-database/icons/white/sql-database-white.svg
  description: 
- name: sql-instance
  colorIcon: assets/img/integrations/k8s-config-connector/components/sql-instance/icons/color/sql-instance-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/sql-instance/icons/white/sql-instance-white.svg
  description: 
- name: sqlssl-cert
  colorIcon: assets/img/integrations/k8s-config-connector/components/sqlssl-cert/icons/color/sqlssl-cert-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/sqlssl-cert/icons/white/sqlssl-cert-white.svg
  description: 
- name: sql-user
  colorIcon: assets/img/integrations/k8s-config-connector/components/sql-user/icons/color/sql-user-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/sql-user/icons/white/sql-user-white.svg
  description: 
- name: storage-hmac-key
  colorIcon: assets/img/integrations/k8s-config-connector/components/storage-hmac-key/icons/color/storage-hmac-key-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/storage-hmac-key/icons/white/storage-hmac-key-white.svg
  description: 
- name: storage-bucket
  colorIcon: assets/img/integrations/k8s-config-connector/components/storage-bucket/icons/color/storage-bucket-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/storage-bucket/icons/white/storage-bucket-white.svg
  description: 
- name: storage-bucket-access-control
  colorIcon: assets/img/integrations/k8s-config-connector/components/storage-bucket-access-control/icons/color/storage-bucket-access-control-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/storage-bucket-access-control/icons/white/storage-bucket-access-control-white.svg
  description: 
- name: storage-default-object-access-control
  colorIcon: assets/img/integrations/k8s-config-connector/components/storage-default-object-access-control/icons/color/storage-default-object-access-control-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/storage-default-object-access-control/icons/white/storage-default-object-access-control-white.svg
  description: 
- name: storage-notification
  colorIcon: assets/img/integrations/k8s-config-connector/components/storage-notification/icons/color/storage-notification-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/storage-notification/icons/white/storage-notification-white.svg
  description: 
- name: storage-transfer-agent-pool
  colorIcon: assets/img/integrations/k8s-config-connector/components/storage-transfer-agent-pool/icons/color/storage-transfer-agent-pool-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/storage-transfer-agent-pool/icons/white/storage-transfer-agent-pool-white.svg
  description: 
- name: storage-transfer-job
  colorIcon: assets/img/integrations/k8s-config-connector/components/storage-transfer-job/icons/color/storage-transfer-job-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/storage-transfer-job/icons/white/storage-transfer-job-white.svg
  description: 
- name: tags-location-tag-binding
  colorIcon: assets/img/integrations/k8s-config-connector/components/tags-location-tag-binding/icons/color/tags-location-tag-binding-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/tags-location-tag-binding/icons/white/tags-location-tag-binding-white.svg
  description: 
- name: tags-tag-binding
  colorIcon: assets/img/integrations/k8s-config-connector/components/tags-tag-binding/icons/color/tags-tag-binding-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/tags-tag-binding/icons/white/tags-tag-binding-white.svg
  description: 
- name: tags-tag-key
  colorIcon: assets/img/integrations/k8s-config-connector/components/tags-tag-key/icons/color/tags-tag-key-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/tags-tag-key/icons/white/tags-tag-key-white.svg
  description: 
- name: tags-tag-value
  colorIcon: assets/img/integrations/k8s-config-connector/components/tags-tag-value/icons/color/tags-tag-value-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/tags-tag-value/icons/white/tags-tag-value-white.svg
  description: 
- name: tpu-node
  colorIcon: assets/img/integrations/k8s-config-connector/components/tpu-node/icons/color/tpu-node-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/tpu-node/icons/white/tpu-node-white.svg
  description: 
- name: vertex-ai-featurestore
  colorIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-featurestore/icons/color/vertex-ai-featurestore-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-featurestore/icons/white/vertex-ai-featurestore-white.svg
  description: 
- name: vertex-ai-featurestore-entity-type
  colorIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-featurestore-entity-type/icons/color/vertex-ai-featurestore-entity-type-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-featurestore-entity-type/icons/white/vertex-ai-featurestore-entity-type-white.svg
  description: 
- name: vertex-ai-featurestore-entity-type-feature
  colorIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-featurestore-entity-type-feature/icons/color/vertex-ai-featurestore-entity-type-feature-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-featurestore-entity-type-feature/icons/white/vertex-ai-featurestore-entity-type-feature-white.svg
  description: 
- name: vertex-ai-index-endpoint
  colorIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-index-endpoint/icons/color/vertex-ai-index-endpoint-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-index-endpoint/icons/white/vertex-ai-index-endpoint-white.svg
  description: 
- name: vertex-ai-metadata-store
  colorIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-metadata-store/icons/color/vertex-ai-metadata-store-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-metadata-store/icons/white/vertex-ai-metadata-store-white.svg
  description: 
- name: vertex-ai-tensorboard
  colorIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-tensorboard/icons/color/vertex-ai-tensorboard-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-tensorboard/icons/white/vertex-ai-tensorboard-white.svg
  description: 
- name: vertex-ai-dataset
  colorIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-dataset/icons/color/vertex-ai-dataset-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-dataset/icons/white/vertex-ai-dataset-white.svg
  description: 
- name: vertex-ai-endpoint
  colorIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-endpoint/icons/color/vertex-ai-endpoint-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-endpoint/icons/white/vertex-ai-endpoint-white.svg
  description: 
- name: vertex-ai-index
  colorIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-index/icons/color/vertex-ai-index-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/vertex-ai-index/icons/white/vertex-ai-index-white.svg
  description: 
- name: vpc-access-connector
  colorIcon: assets/img/integrations/k8s-config-connector/components/vpc-access-connector/icons/color/vpc-access-connector-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/vpc-access-connector/icons/white/vpc-access-connector-white.svg
  description: 
- name: workflows-workflow
  colorIcon: assets/img/integrations/k8s-config-connector/components/workflows-workflow/icons/color/workflows-workflow-color.svg
  whiteIcon: assets/img/integrations/k8s-config-connector/components/workflows-workflow/icons/white/workflows-workflow-white.svg
  description: 
