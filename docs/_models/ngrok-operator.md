...
components: 
- name: ngrok
  colorIcon: assets/img/integrations/ngrok-operator/components/ngrok/icons/color/ngrok-color.svg
  whiteIcon: assets/img/integrations/ngrok-operator/components/ngrok/icons/white/ngrok-white.svg
  description: 
components-count: 1
relationships: 
