...
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where Alertmanager runs with the exact identity of a ServiceAccount"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where Prometheus runs with the exact identity of a ServiceAccount"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where PrometheusAgent runs with the exact identity of a ServiceAccount"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where an Alertmanager discovers and applies AlertmanagerConfig resources"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a PodMonitor auto-discovers and scrapes metrics from any Pod"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Probe actively pings and scrapes any Pod"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Probe actively pings and scrapes any Service"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where Prometheus auto-discovers every PodMonitor"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where Prometheus auto-discovers every Probe"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where Prometheus auto-loads every PrometheusRule"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where Prometheus auto-discovers every ScrapeConfig"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where Prometheus auto-discovers every ServiceMonitor"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where PrometheusAgent auto-discovers every PodMonitor"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where PrometheusAgent auto-discovers every Probe"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where PrometheusAgent auto-loads every PrometheusRule"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where PrometheusAgent auto-discovers every ScrapeConfig"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where PrometheusAgent auto-discovers every ServiceMonitor"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where PrometheusAgent auto-discovers every ServiceMonitor"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where ThanosRuler auto-discovers every PrometheusRule"
