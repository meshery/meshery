...
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno ClusterPolicy reads live secrets from any Secret"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno ClusterPolicy binds to any ServiceAccount"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno ClusterPolicy auto-spawns an UpdateRequest"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno Policy reads live config from any ConfigMap"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno Policy pulls live external truth (HTTP, Vault, AWS Secrets Manager, Git) from any GlobalContextEntry"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno Policy reads live secrets (API keys, certs, tokens) from any Secret"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno Policy binds to any ServiceAccount"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno Policy auto-spawns an UpdateRequest"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno UpdateRequest auto-spawns or updates a Pod"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno CleanupPolicy auto-deletes any Pod"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno CleanupPolicy auto-deletes any Pod"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno ClusterPolicy reads live data from any ConfigMap"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno ClusterPolicy governs every Deployment cluster-wide"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno ClusterPolicy pulls live external data (HTTP, Vault, AWS Secrets Manager, Git) from any GlobalContextEntry"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno ClusterPolicy governs every Pod in the cluster"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno CleanupPolicy auto-deletes any Pod"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno ClusterPolicy governs every Service cluster-wide"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno Policy governs every Deployment in its namespace"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno Policy governs every Pod in its namespace"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno PolicyException carves a safe-pass for any resource by naming the Policy"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno Policy governs every Service in its namespace"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno PolicyException grants VIP bypass to any Deployment"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno PolicyException grants VIP bypass to any Pod"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno PolicyException grants VIP bypass to any Service"
- type: "non-binding"
  kind: "edge"
  description: "An edge relationship where a Kyverno UpdateRequest auto-creates or updates a Deployment"
