...
layout: page
title: Lanzamientos
permalink: /v0.6/es/project/releases
language: es
type: project
---
...
## [v0.6.6](https://github.com/layer5io/meshery/releases/tag/v0.6.6)
...
## [v0.6.5](https://github.com/layer5io/meshery/releases/tag/v0.6.5)
...
## [v0.6.4](https://github.com/layer5io/meshery/releases/tag/v0.6.4)

**¿Qué hay de nuevo?**

- Registro de cambios

## [v0.6.3](https://github.com/layer5io/meshery/releases/tag/v0.6.3)

**¿Qué hay de nuevo?**

- Migrar desde Configurar Meshery a la página Configuración.

## [v0.6.2](https://github.com/layer5io/meshery/releases/tag/v0.6.2)
...
## [v0.6.1](https://github.com/layer5io/meshery/releases/tag/v0.6.1)

**¿Qué hay de nuevo?**

- Parche para el bug Alpine.

## [v0.6.0](https://github.com/layer5io/meshery/releases/tag/v0.6.0)
...
<!-- <table class="responsive-table hover striped">
  ...
  <tbody>
    ...
    <tr><td colspan="3"><strong>v0.6.0</strong></td></tr>
    <tr>
