...
<div class="wrapper" style="text-align: left;">
  ...
  <!-- QUICK START -->
  <div>
    <a href="{{ site.baseurl }}/v0.1/installation/quick-start">
    ...
    <h6><a href="{{ site.baseurl }}/v0.1/installation/platforms" class="text-black section-title">Supported Platforms</a></h6>
    <ul>
  ...
  <!-- CONCEPTS -->
  <div>
    <a href="{{ site.baseurl }}/v0.1/concepts">
        <div class="overview">Concepts</div>
    </a>
    <h6><a href="{{ site.baseurl }}/v0.1/concepts" class="text-black section-title">Concepts</a></h6>
    <ul>
      {% for item in sorted_pages %}
...
<div class="wrapper" style="text-align: left;">
  ...
  <!-- FUNCTIONALITY -->
  <div>
    <a href="{{ site.baseurl }}/v0.1/functionality">
        <div class="overview">Functionality</div>
    </a>
    <h6><a href="{{ site.baseurl }}/v0.1/functionality" class="text-black section-title">Service Mesh Management</a></h6>
    <ul>
      {% for item in sorted_pages %}
    ...
    <h6><a href="{{ site.baseurl }}/v0.1/service-meshes" class="text-black section-title">Service Mesh Specific Management</a></h6>
    <ul>
      {% for item in sorted_pages %}
      {% if item.type=="service-mesh" and item.list!="exclude" and item.language!="es" and item.url contains 'v0.1' -%}
        <li><a href="{{ site.baseurl }}{{ item.url }}">{{ item.title }}</a>
        </li>
        {% endif %}
      {% endfor %}
  ...
  <!-- GUIDES -->
  <div>
    <a href="{{ site.baseurl }}/v0.1/guides">
        <div class="overview">Guides and Reference</div>
    </a>
    <h6><a href="{{ site.baseurl }}/v0.1/guides" class="text-black section-title">Guides</a></h6>
    <ul>
      {% for item in sorted_pages %}
    ...
    <h6><a href="{{ site.baseurl }}/v0.1/reference" class="text-black section-title">Reference</a></h6>
    <ul>
        {% for item in sorted_pages %}
        {% if item.type=="Reference" and item.list!="exclude"  and item.language!="es" and item.url contains 'v0.1' -%}
          <li><a href="{{ site.baseurl }}{{ item.url }}">{{ item.title }}</a>
          </li>
          {% endif %}
        {% endfor %}
