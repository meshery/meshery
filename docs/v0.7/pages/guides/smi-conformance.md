...
You can use [Meshery SMI Conformance GitHub action](https://github.com/meshery/meshery-smi-conformance-action) to run SMI Conformance tests in your CI/CD pipelines.
   ...
   smi-conformance:
     ...
     steps:
       ...
       - name: Validate SMI Conformance
         uses: meshery/mesheryctl-smi-conformance-action@master
         with:
