...
image: /v0.2/assets/img/service-meshes/istio.svg
...
<a href="{{ site.baseurl }}/v0.2/assets/img/adapters/istio/istio-adapter.png">
  <img style="width:500px;" src="{{ site.baseurl }}/v0.2/assets/img/adapters/istio/istio-adapter.png" />
</a>

Click on (+) and choose the {{page.version}} of the {{page.mesh_name}} service mesh.

<a href="{{ site.baseurl }}/v0.2/assets/img/adapters/istio/istio-install.png">
  <img style="width:500px;" src="{{ site.baseurl }}/v0.2/assets/img/adapters/istio/istio-install.png" />
</a>
...
<a href="{{ site.baseurl }}istio-adapter-custom-configuration.png">
  <img style="width:500px;" src="{{ site.baseurl }}/v0.2/assets/img/adapters/istio/istio-adapter-custom-configuration.png" />
</a>
