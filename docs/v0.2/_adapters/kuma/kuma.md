...
image: /v0.2/assets/img/service-meshes/kuma.svg
...
<a href="{{ site.baseurl }}/v0.2/assets/img/adapters/kuma/kuma-adapter.png">
  <img style="width:500px;" src="{{ site.baseurl }}/v0.2/assets/img/adapters/kuma/kuma-adapter.png" />
</a>

Click on (+) and choose the {{page.version}} of the {{page.mesh_name}} service mesh.

<a href="{{ site.baseurl }}/v0.2/assets/img/adapters/kuma/kuma-install.png">
  <img style="width:500px;" src="{{ site.baseurl }}/v0.2/assets/img/adapters/kuma/kuma-install.png" />
</a>
