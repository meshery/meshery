...
I'm eager to start contributing to `meshery/meshery`, particularly focusing on Go-side issues related to `mesheryctl` and the models layer. I am here for the long term and not just for a quick PR. Looking forward to joining the community call soon and getting more involved!
