...
// swagger:route GET /api/server/version ServerAPI idGetServerVersion
// Handle GET requests for Server Version
//
// Fetches the version of running Meshery server
// responses:
// 	200: mesheryServerRespWrapper
