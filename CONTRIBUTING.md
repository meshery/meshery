...
4. Fork this repository (`git clone https://github.com/meshery/meshery.git`), and clone our forked version of Meshery to your development environment, preferably outside `GOPATH`.
