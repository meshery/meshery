...
1. Fork this repository (`git clone https://github.com/meshery/meshery.git`), and clone your forked version of Meshery to your local, preferably outside `GOPATH`.
