...
get_port_protocol(container_ports) := pod_protocol if {
...
checkServiceToContainerPortMap(service_port, container_port) if {
...
edge_network_relationship contains service_name if {
