...
func main() {
	...
	lProv := &models.DefaultLocalProvider{
		...
		PerformanceProfilesPersister:    models.NewPerformanceProfilePersister(dbHandler),
		MesheryPatternPersister:         &models.MesheryPatternPersister{DB: dbHandler},
		MesheryFilterPersister:          models.NewMesheryFilterPersister(dbHandler),
		...
		OrganizationPersister:           models.NewOrganizationPersister(dbHandler),
		...
		KeyPersister:                    models.NewKeyPersister(dbHandler),
