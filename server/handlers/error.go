...
const (
	ErrInvalidK8SConfigNilCode             = "meshery-server-1014(ErrInvalidK8SConfigNilCode)"
	ErrNilClientCode                       = "meshery-server-1015(ErrNilClientCode)"
	ErrRecordPreferencesCode               = "meshery-server-1016(ErrRecordPreferencesCode)"
	ErrGrafanaConfigCode                   = "meshery-server-1017(ErrGrafanaConfigCode)"
	ErrPrometheusConfigCode                = "meshery-server-1018(ErrPrometheusConfigCode)"
	ErrGrafanaQueryCode                    = "meshery-server-1019(ErrGrafanaQueryCode)"
	ErrPrometheusQueryCode                 = "meshery-server-1020(ErrPrometheusQueryCode)"
	ErrPrometheusBoardsCode                = "meshery-server-1021(ErrPrometheusBoardsCode)"
	ErrStaticBoardsCode                    = "meshery-server-1022(ErrStaticBoardsCode)"
	ErrRequestBodyCode                     = "meshery-server-1023(ErrRequestBodyCode)"
	ErrParseBoolCode                       = "meshery-server-1024(ErrParseBoolCode)"
	ErrStreamEventsCode                    = "meshery-server-1025(ErrStreamEventsCode)"
	ErrStreamClientCode                    = "meshery-server-1026(ErrStreamClientCode)"
	ErrPublishSmiResultsCode               = "meshery-server-1027(ErrPublishSmiResultsCode)"
	ErrPluginOpenCode                      = "meshery-server-1028(ErrPluginOpenCode)"
	ErrPluginLookupCode                    = "meshery-server-1029(ErrPluginLookupCode)"
	ErrPluginRunCode                       = "meshery-server-1030(ErrPluginRunCode)"
	ErrParseFormCode                       = "meshery-server-1031(ErrParseFormCode)"
	ErrQueryGetCode                        = "meshery-server-1032(ErrQueryGetCode)"
	ErrGetResultCode                       = "meshery-server-1033(ErrGetResultCode)"
	ErrConvertToSpecCode                   = "meshery-server-1034(ErrConvertToSpecCode)"
	ErrFetchSMIResultsCode                 = "meshery-server-1035(ErrFetchSMIResultsCode)"
	ErrFormFileCode                        = "meshery-server-1036(ErrFormFileCode)"
	ErrReadConfigCode                      = "meshery-server-1037(ErrReadConfigCode)"
	ErrLoadConfigCode                      = "meshery-server-1038(ErrLoadConfigCode)"
	ErrOpenFileCode                        = "meshery-server-1039(ErrOpenFileCode)"
	ErrKubeVersionCode                     = "meshery-server-1040(ErrKubeVersionCode)"
	ErrAddAdapterCode                      = "meshery-server-1041(ErrAddAdapterCode)"
	ErrRetrieveDataCode                    = "meshery-server-1042(ErrRetrieveDataCode)"
	ErrValidAdapterCode                    = "meshery-server-1043(ErrValidAdapterCode)"
	ErrOperationIDCode                     = "meshery-server-1044(ErrOperationIDCode)"
	ErrMeshClientCode                      = "meshery-server-1045(ErrMeshClientCode)"
	ErrApplyChangeCode                     = "meshery-server-1046(ErrApplyChangeCode)"
	ErrRetrieveMeshDataCode                = "meshery-server-1047(ErrRetrieveMeshDataCode)"
	ErrApplicationFailureCode              = "meshery-server-1048(ErrApplicationFailureCode)"
	ErrDecodingCode                        = "meshery-server-1049(ErrDecodingCode)"
	ErrRetrieveUserTokenCode               = "meshery-server-1050(ErrRetrieveUserTokenCode)"
	ErrFailToSaveCode                      = "meshery-server-1051(ErrFailToSaveCode)"
	ErrFailToDeleteCode                    = "meshery-server-1052(ErrFailToDeleteCode)"
	ErrWriteResponseCode                   = "meshery-server-1053(ErrWriteResponseCode)"
	ErrTestConfigsCode                     = "meshery-server-1054(ErrTestConfigsCode)"
	ErrInvalidGenValueCode                 = "meshery-server-1055(ErrInvalidGenValueCode)"
	ErrFailToLoadExtensionsCode            = "meshery-server-1056(ErrFailToLoadExtensionsCode)"
	ErrConversionCode                      = "meshery-server-1057(ErrConversionCode)"
	ErrParseDurationCode                   = "meshery-server-1058(ErrParseDurationCode)"
	ErrLoadTestCode                        = "meshery-server-1059(ErrLoadTestCode)"
	ErrFetchKubernetesCode                 = "meshery-server-1060(ErrFetchKubernetesCode)"
	ErrPanicRecoveryCode                   = "meshery-server-1061(ErrPanicRecoveryCode)"
	ErrBlankNameCode                       = "meshery-server-1062(ErrBlankNameCode)"
	ErrInvalidLTURLCode                    = "meshery-server-1063(ErrInvalidLTURLCode)"
	ErrVersionCompareCode                  = "meshery-server-1064(ErrVersionCompareCode)"
	ErrSaveSessionCode                     = "meshery-server-1065(ErrSaveSessionCode)"
	ErrKubeClientCode                      = "meshery-server-1066(ErrKubeClientCode)"
	ErrWorkloadDefinitionCode              = "meshery-server-1067(ErrWorkloadDefinitionCode)"
	ErrTraitDefinitionCode                 = "meshery-server-1068(ErrTraitDefinitionCode)"
	ErrScopeDefinitionCode                 = "meshery-server-1069(ErrScopeDefinitionCode)"
	ErrPatternFileCode                     = "meshery-server-1070(ErrPatternFileCode)"
	ErrExecutionPlanCode                   = "meshery-server-1071(ErrExecutionPlanCode)"
	ErrInvalidPatternCode                  = "meshery-server-1072(ErrInvalidPatternCode)"
	ErrCompConfigPairsCode                 = "meshery-server-1073(ErrCompConfigPairsCode)"
	ErrCreateDirCode                       = "meshery-server-1074(ErrCreateDirCode)"
	ErrInvalidRequestObjectCode            = "meshery-server-1075(ErrInvalidRequestObjectCode)"
	ErrChangeK8sContextCode                = "meshery-server-1076(ErrChangeK8sContextCode)"
	ErrSavingUserPreferenceCode            = "meshery-server-1077(ErrSavingUserPreferenceCode)"
	ErrGetFilterCode                       = "meshery-server-1078(ErrGetFilterCode)"
	ErrSaveFilterCode                      = "meshery-server-1079(ErrSaveFilterCode)"
	ErrDecodeFilterCode                    = "meshery-server-1080(ErrDecodeFilterCode)"
	ErrEncodeFilterCode                    = "meshery-server-1081(ErrEncodeFilterCode)"
	ErrImportFilterCode                    = "meshery-server-1082(ErrImportFilterCode)"
	ErrFetchFilterCode                     = "meshery-server-1083(ErrFetchFilterCode)"
	ErrDeleteFilterCode                    = "meshery-server-1084(ErrDeleteFilterCode)"
	ErrSavePatternCode                     = "meshery-server-1085(ErrSavePatternCode)"
	ErrSaveApplicationCode                 = "meshery-server-1086(ErrSaveApplicationCode)"
	ErrGetPatternCode                      = "meshery-server-1087(ErrGetPatternCode)"
	ErrDeletePatternCode                   = "meshery-server-1088(ErrDeletePatternCode)"
	ErrFetchPatternCode                    = "meshery-server-1089(ErrFetchPatternCode)"
	ErrImportPatternCode                   = "meshery-server-1090(ErrImportPatternCode)"
	ErrEncodePatternCode                   = "meshery-server-1091(ErrEncodePatternCode)"
	ErrDecodePatternCode                   = "meshery-server-1092(ErrDecodePatternCode)"
	ErrParsePatternCode                    = "meshery-server-1093(ErrParsePatternCode)"
	ErrConvertPatternCode                  = "meshery-server-1094(ErrConvertPatternCode)"
	ErrInvalidKubeConfigCode               = "meshery-server-1095(ErrInvalidKubeConfigCode)"
	ErrInvalidKubeHandlerCode              = "meshery-server-1096(ErrInvalidKubeHandlerCode)"
	ErrInvalidKubeContextCode              = "meshery-server-1097(ErrInvalidKubeContextCode)"
	ErrValidateCode                        = "meshery-server-1098(ErrValidateCode)"
	ErrApplicationContentCode              = "meshery-server-1099(ErrApplicationContentCode)"
	ErrRemoteApplicationURLCode            = "meshery-server-1100(ErrRemoteApplicationURLCode)"
	ErrClonePatternCode                    = "meshery-server-1101(ErrClonePatternCode)"
	ErrCloneFilterCode                     = "meshery-server-1102(ErrCloneFilterCode)"
	ErrGenerateComponentsCode              = "meshery-server-1103(ErrGenerateComponentsCode)"
	ErrPublishCatalogPatternCode           = "meshery-server-1104(ErrPublishCatalogPatternCode)"
	ErrPublishCatalogFilterCode            = "meshery-server-1105(ErrPublishCatalogFilterCode)"
	ErrGetMeshModelsCode                   = "meshery-server-1106(ErrGetMeshModelsCode)"
	ErrGetUserDetailsCode                  = "meshery-server-1107(ErrGetUserDetailsCode)"
	ErrResolvingRelationshipCode           = "meshery-server-1108(ErrResolvingRelationshipCode)"
	ErrGetLatestVersionCode                = "meshery-server-1109(ErrGetLatestVersionCode)"
	ErrCreateFileCode                      = "meshery-server-1110(ErrCreateFileCode)"
	ErrLoadCertificateCode                 = "meshery-server-1111(ErrLoadCertificateCode)"
	ErrCleanupCertificateCode              = "meshery-server-1112(ErrCleanupCertificateCode)"
	ErrDownlaodWASMFileCode                = "meshery-server-1113(ErrDownlaodWASMFileCode)"
	ErrFetchProfileCode                    = "meshery-server-1114(ErrFetchProfileCode)"
	ErrPerformanceTestCode                 = "meshery-server-1115(ErrPerformanceTestCode)"
	ErrFetchApplicationCode                = "meshery-server-1116(ErrFetchApplicationCode)"
	ErrDeleteApplicationCode               = "meshery-server-1117(ErrDeleteApplicationCode)"
	ErrGetEventsCode                       = "meshery-server-1118(ErrGetEventsCode)"
	ErrUpdateEventCode                     = "meshery-server-1119(ErrUpdateEventCode)"
	ErrDeleteEventCode                     = "meshery-server-1120(ErrDeleteEventCode)"
	ErrUnsupportedEventStatusCode          = "meshery-server-1121(ErrUnsupportedEventStatusCode)"
	ErrBulkUpdateEventCode                 = "meshery-server-1122(ErrBulkUpdateEventCode)"
	ErrBulkDeleteEventCode                 = "meshery-server-1123(ErrBulkDeleteEventCode)"
	ErrFetchMeshSyncResourcesCode          = "meshery-server-1124(ErrFetchMeshSyncResourcesCode)"
	ErrDesignSourceContentCode             = "meshery-server-1125(ErrDesignSourceContentCode)"
	ErrGetConnectionsCode                  = "meshery-server-1126(ErrGetConnectionsCode)"
	ErrWritingIntoFileCode                 = "meshery-server-1127(ErrWritingIntoFileCode)"
	ErrBuildOCIImgCode                     = "meshery-server-1128(ErrBuildOCIImgCode)"
	ErrSaveOCIArtifactCode                 = "meshery-server-1129(ErrSaveOCIArtifactCode)"
	ErrIOReaderCode                        = "meshery-server-1130(ErrIOReaderCode)"
	ErrUnCompressOCIArtifactCode           = "meshery-server-1131(ErrUnCompressOCIArtifactCode)"
	ErrWaklingLocalDirectoryCode           = "meshery-server-1132(ErrWaklingLocalDirectoryCode)"
	ErrConvertingK8sManifestToDesignCode   = "meshery-server-1133(ErrConvertingK8sManifestToDesignCode)"
	ErrConvertingDockerComposeToDesignCode = "meshery-server-1134(ErrConvertingDockerComposeToDesignCode)"
	ErrMarshallingDesignIntoYAMLCode       = "meshery-server-1135(ErrMarshallingDesignIntoYAMLCode)"
	ErrConvertingHelmChartToDesignCode     = "meshery-server-1136(ErrConvertingHelmChartToDesignCode)"
	ErrInvalidUUIDCode                     = "meshery-server-1137(ErrInvalidUUIDCode)"
	ErrPersistEventToRemoteProviderCode    = "meshery-server-1320(ErrPersistEventToRemoteProviderCode)"
)
