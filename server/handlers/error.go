...
const (
	ErrInvalidK8SConfigNilCode             = "component-meshery-server-ErrInvalidK8SConfigNilCode-1014"
	ErrNilClientCode                       = "component-meshery-server-ErrNilClientCode-1015"
	ErrRecordPreferencesCode               = "component-meshery-server-ErrRecordPreferencesCode-1016"
	ErrGrafanaConfigCode                   = "component-meshery-server-ErrGrafanaConfigCode-1017"
	ErrPrometheusConfigCode                = "component-meshery-server-ErrPrometheusConfigCode-1018"
	ErrGrafanaQueryCode                    = "component-meshery-server-ErrGrafanaQueryCode-1019"
	ErrPrometheusQueryCode                 = "component-meshery-server-ErrPrometheusQueryCode-1020"
	ErrPrometheusBoardsCode                = "component-meshery-server-ErrPrometheusBoardsCode-1021"
	ErrStaticBoardsCode                    = "component-meshery-server-ErrStaticBoardsCode-1022"
	ErrRequestBodyCode                     = "component-meshery-server-ErrRequestBodyCode-1023"
	ErrParseBoolCode                       = "component-meshery-server-ErrParseBoolCode-1024"
	ErrStreamEventsCode                    = "component-meshery-server-ErrStreamEventsCode-1025"
	ErrStreamClientCode                    = "component-meshery-server-ErrStreamClientCode-1026"
	ErrPublishSmiResultsCode               = "component-meshery-server-ErrPublishSmiResultsCode-1027"
	ErrPluginOpenCode                      = "component-meshery-server-ErrPluginOpenCode-1028"
	ErrPluginLookupCode                    = "component-meshery-server-ErrPluginLookupCode-1029"
	ErrPluginRunCode                       = "component-meshery-server-ErrPluginRunCode-1030"
	ErrParseFormCode                       = "component-meshery-server-ErrParseFormCode-1031"
	ErrQueryGetCode                        = "component-meshery-server-ErrQueryGetCode-1032"
	ErrGetResultCode                       = "component-meshery-server-ErrGetResultCode-1033"
	ErrConvertToSpecCode                   = "component-meshery-server-ErrConvertToSpecCode-1034"
	ErrFetchSMIResultsCode                 = "component-meshery-server-ErrFetchSMIResultsCode-1035"
	ErrFormFileCode                        = "component-meshery-server-ErrFormFileCode-1036"
	ErrReadConfigCode                      = "component-meshery-server-ErrReadConfigCode-1037"
	ErrLoadConfigCode                      = "component-meshery-server-ErrLoadConfigCode-1038"
	ErrOpenFileCode                        = "component-meshery-server-ErrOpenFileCode-1039"
	ErrKubeVersionCode                     = "component-meshery-server-ErrKubeVersionCode-1040"
	ErrAddAdapterCode                      = "component-meshery-server-ErrAddAdapterCode-1041"
	ErrRetrieveDataCode                    = "component-meshery-server-ErrRetrieveDataCode-1042"
	ErrValidAdapterCode                    = "component-meshery-server-ErrValidAdapterCode-1043"
	ErrOperationIDCode                     = "component-meshery-server-ErrOperationIDCode-1044"
	ErrMeshClientCode                      = "component-meshery-server-ErrMeshClientCode-1045"
	ErrApplyChangeCode                     = "component-meshery-server-ErrApplyChangeCode-1046"
	ErrRetrieveMeshDataCode                = "component-meshery-server-ErrRetrieveMeshDataCode-1047"
	ErrApplicationFailureCode              = "component-meshery-server-ErrApplicationFailureCode-1048"
	ErrDecodingCode                        = "component-meshery-server-ErrDecodingCode-1049"
	ErrRetrieveUserTokenCode               = "component-meshery-server-ErrRetrieveUserTokenCode-1050"
	ErrFailToSaveCode                      = "component-meshery-server-ErrFailToSaveCode-1051"
	ErrFailToDeleteCode                    = "component-meshery-server-ErrFailToDeleteCode-1052"
	ErrWriteResponseCode                   = "component-meshery-server-ErrWriteResponseCode-1053"
	ErrTestConfigsCode                     = "component-meshery-server-ErrTestConfigsCode-1054"
	ErrInvalidGenValueCode                 = "component-meshery-server-ErrInvalidGenValueCode-1055"
	ErrFailToLoadExtensionsCode            = "component-meshery-server-ErrFailToLoadExtensionsCode-1056"
	ErrConversionCode                      = "component-meshery-server-ErrConversionCode-1057"
	ErrParseDurationCode                   = "component-meshery-server-ErrParseDurationCode-1058"
	ErrLoadTestCode                        = "component-meshery-server-ErrLoadTestCode-1059"
	ErrFetchKubernetesCode                 = "component-meshery-server-ErrFetchKubernetesCode-1060"
	ErrPanicRecoveryCode                   = "component-meshery-server-ErrPanicRecoveryCode-1061"
	ErrBlankNameCode                       = "component-meshery-server-ErrBlankNameCode-1062"
	ErrInvalidLTURLCode                    = "component-meshery-server-ErrInvalidLTURLCode-1063"
	ErrVersionCompareCode                  = "component-meshery-server-ErrVersionCompareCode-1064"
	ErrSaveSessionCode                     = "component-meshery-server-ErrSaveSessionCode-1065"
	ErrKubeClientCode                      = "component-meshery-server-ErrKubeClientCode-1066"
	ErrWorkloadDefinitionCode              = "component-meshery-server-ErrWorkloadDefinitionCode-1067"
	ErrTraitDefinitionCode                 = "component-meshery-server-ErrTraitDefinitionCode-1068"
	ErrScopeDefinitionCode                 = "component-meshery-server-ErrScopeDefinitionCode-1069"
	ErrPatternFileCode                     = "component-meshery-server-ErrPatternFileCode-1070"
	ErrExecutionPlanCode                   = "component-meshery-server-ErrExecutionPlanCode-1071"
	ErrInvalidPatternCode                  = "component-meshery-server-ErrInvalidPatternCode-1072"
	ErrCompConfigPairsCode                 = "component-meshery-server-ErrCompConfigPairsCode-1073"
	ErrCreateDirCode                       = "component-meshery-server-ErrCreateDirCode-1074"
	ErrInvalidRequestObjectCode            = "component-meshery-server-ErrInvalidRequestObjectCode-1075"
	ErrChangeK8sContextCode                = "component-meshery-server-ErrChangeK8sContextCode-1076"
	ErrSavingUserPreferenceCode            = "component-meshery-server-ErrSavingUserPreferenceCode-1077"
	ErrGetFilterCode                       = "component-meshery-server-ErrGetFilterCode-1078"
	ErrSaveFilterCode                      = "component-meshery-server-ErrSaveFilterCode-1079"
	ErrDecodeFilterCode                    = "component-meshery-server-ErrDecodeFilterCode-1080"
	ErrEncodeFilterCode                    = "component-meshery-server-ErrEncodeFilterCode-1081"
	ErrImportFilterCode                    = "component-meshery-server-ErrImportFilterCode-1082"
	ErrFetchFilterCode                     = "component-meshery-server-ErrFetchFilterCode-1083"
	ErrDeleteFilterCode                    = "component-meshery-server-ErrDeleteFilterCode-1084"
	ErrSavePatternCode                     = "component-meshery-server-ErrSavePatternCode-1085"
	ErrSaveApplicationCode                 = "component-meshery-server-ErrSaveApplicationCode-1086"
	ErrGetPatternCode                      = "component-meshery-server-ErrGetPatternCode-1087"
	ErrDeletePatternCode                   = "component-meshery-server-ErrDeletePatternCode-1088"
	ErrFetchPatternCode                    = "component-meshery-server-ErrFetchPatternCode-1089"
	ErrImportPatternCode                   = "component-meshery-server-ErrImportPatternCode-1090"
	ErrEncodePatternCode                   = "component-meshery-server-ErrEncodePatternCode-1091"
	ErrDecodePatternCode                   = "component-meshery-server-ErrDecodePatternCode-1092"
	ErrParsePatternCode                    = "component-meshery-server-ErrParsePatternCode-1093"
	ErrConvertPatternCode                  = "component-meshery-server-ErrConvertPatternCode-1094"
	ErrInvalidKubeConfigCode               = "component-meshery-server-ErrInvalidKubeConfigCode-1095"
	ErrInvalidKubeHandlerCode              = "component-meshery-server-ErrInvalidKubeHandlerCode-1096"
	ErrInvalidKubeContextCode              = "component-meshery-server-ErrInvalidKubeContextCode-1097"
	ErrValidateCode                        = "component-meshery-server-ErrValidateCode-1098"
	ErrApplicationContentCode              = "component-meshery-server-ErrApplicationContentCode-1099"
	ErrRemoteApplicationURLCode            = "component-meshery-server-ErrRemoteApplicationURLCode-1100"
	ErrClonePatternCode                    = "component-meshery-server-ErrClonePatternCode-1101"
	ErrCloneFilterCode                     = "component-meshery-server-ErrCloneFilterCode-1102"
	ErrGenerateComponentsCode              = "component-meshery-server-ErrGenerateComponentsCode-1103"
	ErrPublishCatalogPatternCode           = "component-meshery-server-ErrPublishCatalogPatternCode-1104"
	ErrPublishCatalogFilterCode            = "component-meshery-server-ErrPublishCatalogFilterCode-1105"
	ErrGetMeshModelsCode                   = "component-meshery-server-ErrGetMeshModelsCode-1106"
	ErrGetUserDetailsCode                  = "component-meshery-server-ErrGetUserDetailsCode-1107"
	ErrResolvingRelationshipCode           = "component-meshery-server-ErrResolvingRelationshipCode-1108"
	ErrGetLatestVersionCode                = "component-meshery-server-ErrGetLatestVersionCode-1109"
	ErrCreateFileCode                      = "component-meshery-server-ErrCreateFileCode-1110"
	ErrLoadCertificateCode                 = "component-meshery-server-ErrLoadCertificateCode-1111"
	ErrCleanupCertificateCode              = "component-meshery-server-ErrCleanupCertificateCode-1112"
	ErrDownlaodWASMFileCode                = "component-meshery-server-ErrDownlaodWASMFileCode-1113"
	ErrFetchProfileCode                    = "component-meshery-server-ErrFetchProfileCode-1114"
	ErrPerformanceTestCode                 = "component-meshery-server-ErrPerformanceTestCode-1115"
	ErrFetchApplicationCode                = "component-meshery-server-ErrFetchApplicationCode-1116"
	ErrDeleteApplicationCode               = "component-meshery-server-ErrDeleteApplicationCode-1117"
	ErrGetEventsCode                       = "component-meshery-server-ErrGetEventsCode-1118"
	ErrUpdateEventCode                     = "component-meshery-server-ErrUpdateEventCode-1119"
	ErrDeleteEventCode                     = "component-meshery-server-ErrDeleteEventCode-1120"
	ErrUnsupportedEventStatusCode          = "component-meshery-server-ErrUnsupportedEventStatusCode-1121"
	ErrBulkUpdateEventCode                 = "component-meshery-server-ErrBulkUpdateEventCode-1122"
	ErrBulkDeleteEventCode                 = "component-meshery-server-ErrBulkDeleteEventCode-1123"
	ErrFetchMeshSyncResourcesCode          = "component-meshery-server-ErrFetchMeshSyncResourcesCode-1124"
	ErrDesignSourceContentCode             = "component-meshery-server-ErrDesignSourceContentCode-1125"
	ErrGetConnectionsCode                  = "component-meshery-server-ErrGetConnectionsCode-1126"
	ErrWritingIntoFileCode                 = "component-meshery-server-ErrWritingIntoFileCode-1127"
	ErrBuildOCIImgCode                     = "component-meshery-server-ErrBuildOCIImgCode-1128"
	ErrSaveOCIArtifactCode                 = "component-meshery-server-ErrSaveOCIArtifactCode-1129"
	ErrIOReaderCode                        = "component-meshery-server-ErrIOReaderCode-1130"
	ErrUnCompressOCIArtifactCode           = "component-meshery-server-ErrUnCompressOCIArtifactCode-1131"
	ErrWaklingLocalDirectoryCode           = "component-meshery-server-ErrWaklingLocalDirectoryCode-1132"
	ErrConvertingK8sManifestToDesignCode   = "component-meshery-server-ErrConvertingK8sManifestToDesignCode-1133"
	ErrConvertingDockerComposeToDesignCode = "component-meshery-server-ErrConvertingDockerComposeToDesignCode-1134"
	ErrMarshallingDesignIntoYAMLCode       = "component-meshery-server-ErrMarshallingDesignIntoYAMLCode-1135"
	ErrConvertingHelmChartToDesignCode     = "component-meshery-server-ErrConvertingHelmChartToDesignCode-1136"
	ErrInvalidUUIDCode                     = "component-meshery-server-ErrInvalidUUIDCode-1137"
	ErrPersistEventToRemoteProviderCode    = "component-meshery-server-ErrPersistEventToRemoteProviderCode-1320"
)
