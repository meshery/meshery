...
const (
	ErrErrNewDynamicClientGeneratorCode    = "meshery-server-1138(ErrErrNewDynamicClientGeneratorCode)"
	ErrInvalidK8SConfigCode                = "meshery-server-1139(ErrInvalidK8SConfigCode)"
	ErrClientConfigCode                    = "meshery-server-1140(ErrClientConfigCode)"
	ErrFetchKubernetesNodesCode            = "meshery-server-1141(ErrFetchKubernetesNodesCode)"
	ErrFetchNodesCode                      = "meshery-server-1142(ErrFetchNodesCode)"
	ErrFetchKubernetesVersionCode          = "meshery-server-1143(ErrFetchKubernetesVersionCode)"
	ErrScanKubernetesCode                  = "meshery-server-1144(ErrScanKubernetesCode)"
	ErrRetrievePodListCode                 = "meshery-server-1145(ErrRetrievePodListCode)"
	ErrDetectServiceForDeploymentImageCode = "meshery-server-1146(ErrDetectServiceForDeploymentImageCode)"
	ErrRetrieveNamespacesListCode          = "meshery-server-1147(ErrRetrieveNamespacesListCode)"
	ErrGetNamespaceDeploymentsCode         = "meshery-server-1148(ErrGetNamespaceDeploymentsCode)"
	ErrDetectServiceWithNameCode           = "meshery-server-1149(ErrDetectServiceWithNameCode)"
	ErrGeneratingLoadTestCode              = "meshery-server-1150(ErrGeneratingLoadTestCode)"
	ErrRunningTestCode                     = "meshery-server-1151(ErrRunningTestCode)"
	ErrConvertingResultToMapCode           = "meshery-server-1152(ErrConvertingResultToMapCode)"
	ErrGrpcSupportCode                     = "meshery-server-1153(ErrGrpcSupportCode)"
	ErrStartingNighthawkServerCode         = "meshery-server-1154(ErrStartingNighthawkServerCode)"
	ErrTransformingDataCode                = "meshery-server-1155(ErrTransformingDataCode)"
	ErrRunningNighthawkServerCode          = "meshery-server-1156(ErrRunningNighthawkServerCode)"
	ErrAddAndValidateExtraHeaderCode       = "meshery-server-1157(ErrAddAndValidateExtraHeaderCode)"
	ErrInClusterConfigCode                 = "meshery-server-1158(ErrInClusterConfigCode)"
	ErrNewKubeClientGeneratorCode          = "meshery-server-1159(ErrNewKubeClientGeneratorCode)"
	ErrRestConfigFromKubeConfigCode        = "meshery-server-1160(ErrRestConfigFromKubeConfigCode)"
	ErrNewKubeClientCode                   = "meshery-server-1161(ErrNewKubeClientCode)"
	ErrAdapterInsufficientInformationCode  = "meshery-server-1162(ErrAdapterInsufficientInformationCode)"
	ErrDeployingAdapterInK8sEnvCode        = "meshery-server-1163(ErrDeployingAdapterInK8sEnvCode)"
	ErrUnDeployingAdapterInK8sEnvCode      = "meshery-server-1164(ErrUnDeployingAdapterInK8sEnvCode)"
	ErrDeployingAdapterInDockerEnvCode     = "meshery-server-1165(ErrDeployingAdapterInDockerEnvCode)"
	ErrUnDeployingAdapterInDockerEnvCode   = "meshery-server-1166(ErrUnDeployingAdapterInDockerEnvCode)"
	ErrDeployingAdapterCode                = "meshery-server-1167(ErrDeployingAdapterCode)"
	ErrUnDeployingAdapterCode              = "meshery-server-1168(ErrUnDeployingAdapterCode)"
	ErrClientSetCode                       = "meshery-server-1169(ErrClientSetCode)"
)
