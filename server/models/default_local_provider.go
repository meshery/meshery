...
func (l *DefaultLocalProvider) GetMesheryPatterns(tokenString, page, pageSize, search, order string, updated_after string) ([]byte, error) {
	if page == "" {
		page = "0"
	}
	if pageSize == "" {
	...
	return l.MesheryPatternPersister.GetMesheryPatterns(search, order, pg, pgs, updated_after)
}
...
func (l *DefaultLocalProvider) GetMesheryApplications(tokenString, page, pageSize, search, order string, updated_after string) ([]byte, error) {
	if page == "" {
		page = "0"
	}
	if pageSize == "" {
	...
	return l.MesheryApplicationPersister.GetMesheryApplications(search, order, pg, pgs, updated_after)
}
