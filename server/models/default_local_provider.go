...
func (l *DefaultLocalProvider) GetCatalogMesheryPatterns(_, page, pageSize, search, order, _, _ string, class, technology, patternType, orgID, userid []string) ([]byte, error) {
