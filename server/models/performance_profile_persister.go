...
func (ppp *PerformanceProfilePersister) GetPerformanceProfiles(search, order string, page, pageSize uint64) ([]byte, error) {
...
func (ppp *PerformanceProfilePersister) SavePerformanceProfile(profile *PerformanceProfile) error {
