...
const (
	ErrGrafanaClientCode                  = "component-meshery-server-ErrGrafanaClientCode-1220"
	ErrPageSizeCode                       = "component-meshery-server-ErrPageSizeCode-1221"
	ErrPageNumberCode                     = "component-meshery-server-ErrPageNumberCode-1222"
	ErrResultIDCode                       = "component-meshery-server-ErrResultIDCode-1223"
	ErrPerfIDCode                         = "component-meshery-server-ErrPerfIDCode-1224"
	ErrMarshalCode                        = "component-meshery-server-ErrMarshalCode-1225"
	ErrUnmarshalCode                      = "component-meshery-server-ErrUnmarshalCode-1226"
	ErrGenerateUUIDCode                   = "component-meshery-server-ErrGenerateUUIDCode-1227"
	ErrLocalProviderSupportCode           = "component-meshery-server-ErrLocalProviderSupportCode-1228"
	ErrGrafanaOrgCode                     = "component-meshery-server-ErrGrafanaOrgCode-1229"
	ErrGrafanaBoardsCode                  = "component-meshery-server-ErrGrafanaBoardsCode-1230"
	ErrGrafanaDashboardCode               = "component-meshery-server-ErrGrafanaDashboardCode-1231"
	ErrGrafanaDataSourceCode              = "component-meshery-server-ErrGrafanaDataSourceCode-1232"
	ErrNilQueryCode                       = "component-meshery-server-ErrNilQueryCode-1233"
	ErrGrafanaDataCode                    = "component-meshery-server-ErrGrafanaDataCode-1234"
	ErrApplicationFileNameCode            = "component-meshery-server-ErrApplicationFileNameCode-1235"
	ErrFilterFileNameCode                 = "component-meshery-server-ErrFilterFileNameCode-1236"
	ErrPatternFileNameCode                = "component-meshery-server-ErrPatternFileNameCode-1237"
	ErrMakeDirCode                        = "component-meshery-server-ErrMakeDirCode-1238"
	ErrFolderStatCode                     = "component-meshery-server-ErrFolderStatCode-1239"
	ErrUserIDCode                         = "component-meshery-server-ErrUserIDCode-1240"
	ErrDBConnectionCode                   = "component-meshery-server-ErrDBConnectionCode-1241"
	ErrNilConfigDataCode                  = "component-meshery-server-ErrNilConfigDataCode-1242"
	ErrDBOpenCode                         = "component-meshery-server-ErrDBOpenCode-1243"
	ErrDBRLockCode                        = "component-meshery-server-ErrDBRLockCode-1244"
	ErrDBLockCode                         = "component-meshery-server-ErrDBLockCode-1245"
	ErrDBReadCode                         = "component-meshery-server-ErrDBReadCode-1246"
	ErrDBDeleteCode                       = "component-meshery-server-ErrDBDeleteCode-1247"
	ErrCopyCode                           = "component-meshery-server-ErrCopyCode-1248"
	ErrDBPutCode                          = "component-meshery-server-ErrDBPutCode-1249"
	ErrPrometheusGetNodesCode             = "component-meshery-server-ErrPrometheusGetNodesCode-1250"
	ErrPrometheusLabelSeriesCode          = "component-meshery-server-ErrPrometheusLabelSeriesCode-1251"
	ErrPrometheusQueryRangeCode           = "component-meshery-server-ErrPrometheusQueryRangeCode-1252"
	ErrPrometheusStaticBoardCode          = "component-meshery-server-ErrPrometheusStaticBoardCode-1253"
	ErrTokenRefreshCode                   = "component-meshery-server-ErrTokenRefreshCode-1254"
	ErrGetTokenCode                       = "component-meshery-server-ErrGetTokenCode-1255"
	ErrDataReadCode                       = "component-meshery-server-ErrDataReadCode-1256"
	ErrTokenDecodeCode                    = "component-meshery-server-ErrTokenDecodeCode-1257"
	ErrNilJWKsCode                        = "component-meshery-server-ErrNilJWKsCode-1258"
	ErrNilKeysCode                        = "component-meshery-server-ErrNilKeysCode-1259"
	ErrTokenExpiredCode                   = "component-meshery-server-ErrTokenExpiredCode-1260"
	ErrTokenClaimsCode                    = "component-meshery-server-ErrTokenClaimsCode-1261"
	ErrTokenClientCheckCode               = "component-meshery-server-ErrTokenClientCheckCode-1262"
	ErrTokenPraseCode                     = "component-meshery-server-ErrTokenPraseCode-1263"
	ErrJWKsKeysCode                       = "component-meshery-server-ErrJWKsKeysCode-1264"
	ErrDecodeBase64Code                   = "component-meshery-server-ErrDecodeBase64Code-1265"
	ErrMarshalPKIXCode                    = "component-meshery-server-ErrMarshalPKIXCode-1266"
	ErrEncodingPEMCode                    = "component-meshery-server-ErrEncodingPEMCode-1267"
	ErrPraseUnverifiedCode                = "component-meshery-server-ErrPraseUnverifiedCode-1268"
	ErrEncodingCode                       = "component-meshery-server-ErrEncodingCode-1269"
	ErrFetchCode                          = "component-meshery-server-ErrFetchCode-1270"
	ErrPostCode                           = "component-meshery-server-ErrPostCode-1271"
	ErrDeleteCode                         = "component-meshery-server-ErrDeleteCode-1272"
	ErrInvalidCapabilityCode              = "component-meshery-server-ErrInvalidCapabilityCode-1273"
	ErrResultDataCode                     = "component-meshery-server-ErrResultDataCode-1274"
	ErrUnableToPersistsResultCode         = "component-meshery-server-ErrUnableToPersistsResultCode-1275"
	ErrValidURLCode                       = "component-meshery-server-ErrValidURLCode-1276"
	ErrTestEndpointCode                   = "component-meshery-server-ErrTestEndpointCode-1277"
	ErrLoadgeneratorCode                  = "component-meshery-server-ErrLoadgeneratorCode-1278"
	ErrProtocolCode                       = "component-meshery-server-ErrProtocolCode-1279"
	ErrTestClientCode                     = "component-meshery-server-ErrTestClientCode-1280"
	ErrParsingTestCode                    = "component-meshery-server-ErrParsingTestCode-1281"
	ErrFieldCode                          = "component-meshery-server-ErrFieldCode-1282"
	ErrFetchDataCode                      = "component-meshery-server-ErrFetchDataCode-1283"
	ErrIndexOutOfRangeCode                = "component-meshery-server-ErrIndexOutOfRangeCode-1284"
	ErrSessionCopyCode                    = "component-meshery-server-ErrSessionCopyCode-1285"
	ErrSavingSeededComponentsCode         = "component-meshery-server-ErrSavingSeededComponentsCode-1286"
	ErrGettingSeededComponentsCode        = "component-meshery-server-ErrGettingSeededComponentsCode-1287"
	ErrDownloadingSeededComponentsCode    = "component-meshery-server-ErrDownloadingSeededComponentsCode-1288"
	ErrContextIDCode                      = "component-meshery-server-ErrContextIDCode-1289"
	ErrMesheryInstanceIDCode              = "component-meshery-server-ErrMesheryInstanceIDCode-1290"
	ErrMesheryNotInClusterCode            = "component-meshery-server-ErrMesheryNotInClusterCode-1291"
	ErrBrokerNotFoundCode                 = "component-meshery-server-ErrBrokerNotFoundCode-1292"
	ErrCreateOperatorDeploymentConfigCode = "component-meshery-server-ErrCreateOperatorDeploymentConfigCode-1293"
	ErrRequestMeshsyncStoreCode           = "component-meshery-server-ErrRequestMeshsyncStoreCode-1294"
	ErrBrokerSubscriptionCode             = "component-meshery-server-ErrBrokerSubscriptionCode-1295"
	ErrContextAlreadyPersistedCode        = "component-meshery-server-ErrContextAlreadyPersistedCode-1296"
	ErrGetPackageCode                     = "component-meshery-server-ErrGetPackageCode-1297"
	ErrTokenRevokeCode                    = "component-meshery-server-ErrTokenRevokeCode-1298"
	ErrTokenIntrospectCode                = "component-meshery-server-ErrTokenIntrospectCode-1299"
	ErrShareDesignCode                    = "component-meshery-server-ErrShareDesignCode-1300"
	ErrUnreachableRemoteProviderCode      = "component-meshery-server-ErrUnreachableRemoteProviderCode-1301"
	ErrShareFilterCode                    = "component-meshery-server-ErrShareFilterCode-1302"
	ErrPersistEventCode                   = "component-meshery-server-ErrPersistEventCode-1303"
	ErrUnreachableKubeAPICode             = "component-meshery-server-ErrUnreachableKubeAPICode-1304"
	ErrFlushMeshSyncDataCode              = "component-meshery-server-ErrFlushMeshSyncDataCode-1305"
	ErrUpdateConnectionStatusCode         = "component-meshery-server-ErrUpdateConnectionStatusCode-1306"
	ErrResultNotFoundCode                 = "component-meshery-server-ErrResultNotFoundCode-1307"
	ErrPersistCredentialCode              = "component-meshery-server-ErrPersistCredentialCode-1308"
	ErrPersistConnectionCode              = "component-meshery-server-ErrPersistConnectionCode-1309"
	ErrPrometheusScanCode                 = "component-meshery-server-ErrPrometheusScanCode-1310"
	ErrGrafanaScanCode                    = "component-meshery-server-ErrGrafanaScanCode-1311"
	ErrDBCreateCode                       = "component-meshery-server-ErrDBCreateCode-1312"
	ErrDoRequestCode                      = "component-meshery-server-ErrDoRequestCode-1321"
)
