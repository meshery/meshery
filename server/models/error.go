...
const (
	ErrGrafanaClientCode                  = "meshery-server-1220(ErrGrafanaClientCode)"
	ErrPageSizeCode                       = "meshery-server-1221(ErrPageSizeCode)"
	ErrPageNumberCode                     = "meshery-server-1222(ErrPageNumberCode)"
	ErrResultIDCode                       = "meshery-server-1223(ErrResultIDCode)"
	ErrPerfIDCode                         = "meshery-server-1224(ErrPerfIDCode)"
	ErrMarshalCode                        = "meshery-server-1225(ErrMarshalCode)"
	ErrUnmarshalCode                      = "meshery-server-1226(ErrUnmarshalCode)"
	ErrGenerateUUIDCode                   = "meshery-server-1227(ErrGenerateUUIDCode)"
	ErrLocalProviderSupportCode           = "meshery-server-1228(ErrLocalProviderSupportCode)"
	ErrGrafanaOrgCode                     = "meshery-server-1229(ErrGrafanaOrgCode)"
	ErrGrafanaBoardsCode                  = "meshery-server-1230(ErrGrafanaBoardsCode)"
	ErrGrafanaDashboardCode               = "meshery-server-1231(ErrGrafanaDashboardCode)"
	ErrGrafanaDataSourceCode              = "meshery-server-1232(ErrGrafanaDataSourceCode)"
	ErrNilQueryCode                       = "meshery-server-1233(ErrNilQueryCode)"
	ErrGrafanaDataCode                    = "meshery-server-1234(ErrGrafanaDataCode)"
	ErrApplicationFileNameCode            = "meshery-server-1235(ErrApplicationFileNameCode)"
	ErrFilterFileNameCode                 = "meshery-server-1236(ErrFilterFileNameCode)"
	ErrPatternFileNameCode                = "meshery-server-1237(ErrPatternFileNameCode)"
	ErrMakeDirCode                        = "meshery-server-1238(ErrMakeDirCode)"
	ErrFolderStatCode                     = "meshery-server-1239(ErrFolderStatCode)"
	ErrUserIDCode                         = "meshery-server-1240(ErrUserIDCode)"
	ErrDBConnectionCode                   = "meshery-server-1241(ErrDBConnectionCode)"
	ErrNilConfigDataCode                  = "meshery-server-1242(ErrNilConfigDataCode)"
	ErrDBOpenCode                         = "meshery-server-1243(ErrDBOpenCode)"
	ErrDBRLockCode                        = "meshery-server-1244(ErrDBRLockCode)"
	ErrDBLockCode                         = "meshery-server-1245(ErrDBLockCode)"
	ErrDBReadCode                         = "meshery-server-1246(ErrDBReadCode)"
	ErrDBDeleteCode                       = "meshery-server-1247(ErrDBDeleteCode)"
	ErrCopyCode                           = "meshery-server-1248(ErrCopyCode)"
	ErrDBPutCode                          = "meshery-server-1249(ErrDBPutCode)"
	ErrPrometheusGetNodesCode             = "meshery-server-1250(ErrPrometheusGetNodesCode)"
	ErrPrometheusLabelSeriesCode          = "meshery-server-1251(ErrPrometheusLabelSeriesCode)"
	ErrPrometheusQueryRangeCode           = "meshery-server-1252(ErrPrometheusQueryRangeCode)"
	ErrPrometheusStaticBoardCode          = "meshery-server-1253(ErrPrometheusStaticBoardCode)"
	ErrTokenRefreshCode                   = "meshery-server-1254(ErrTokenRefreshCode)"
	ErrGetTokenCode                       = "meshery-server-1255(ErrGetTokenCode)"
	ErrDataReadCode                       = "meshery-server-1256(ErrDataReadCode)"
	ErrTokenDecodeCode                    = "meshery-server-1257(ErrTokenDecodeCode)"
	ErrNilJWKsCode                        = "meshery-server-1258(ErrNilJWKsCode)"
	ErrNilKeysCode                        = "meshery-server-1259(ErrNilKeysCode)"
	ErrTokenExpiredCode                   = "meshery-server-1260(ErrTokenExpiredCode)"
	ErrTokenClaimsCode                    = "meshery-server-1261(ErrTokenClaimsCode)"
	ErrTokenClientCheckCode               = "meshery-server-1262(ErrTokenClientCheckCode)"
	ErrTokenPraseCode                     = "meshery-server-1263(ErrTokenPraseCode)"
	ErrJWKsKeysCode                       = "meshery-server-1264(ErrJWKsKeysCode)"
	ErrDecodeBase64Code                   = "meshery-server-1265(ErrDecodeBase64Code)"
	ErrMarshalPKIXCode                    = "meshery-server-1266(ErrMarshalPKIXCode)"
	ErrEncodingPEMCode                    = "meshery-server-1267(ErrEncodingPEMCode)"
	ErrPraseUnverifiedCode                = "meshery-server-1268(ErrPraseUnverifiedCode)"
	ErrEncodingCode                       = "meshery-server-1269(ErrEncodingCode)"
	ErrFetchCode                          = "meshery-server-1270(ErrFetchCode)"
	ErrPostCode                           = "meshery-server-1271(ErrPostCode)"
	ErrDeleteCode                         = "meshery-server-1272(ErrDeleteCode)"
	ErrInvalidCapabilityCode              = "meshery-server-1273(ErrInvalidCapabilityCode)"
	ErrResultDataCode                     = "meshery-server-1274(ErrResultDataCode)"
	ErrUnableToPersistsResultCode         = "meshery-server-1275(ErrUnableToPersistsResultCode)"
	ErrValidURLCode                       = "meshery-server-1276(ErrValidURLCode)"
	ErrTestEndpointCode                   = "meshery-server-1277(ErrTestEndpointCode)"
	ErrLoadgeneratorCode                  = "meshery-server-1278(ErrLoadgeneratorCode)"
	ErrProtocolCode                       = "meshery-server-1279(ErrProtocolCode)"
	ErrTestClientCode                     = "meshery-server-1280(ErrTestClientCode)"
	ErrParsingTestCode                    = "meshery-server-1281(ErrParsingTestCode)"
	ErrFieldCode                          = "meshery-server-1282(ErrFieldCode)"
	ErrFetchDataCode                      = "meshery-server-1283(ErrFetchDataCode)"
	ErrIndexOutOfRangeCode                = "meshery-server-1284(ErrIndexOutOfRangeCode)"
	ErrSessionCopyCode                    = "meshery-server-1285(ErrSessionCopyCode)"
	ErrSavingSeededComponentsCode         = "meshery-server-1286(ErrSavingSeededComponentsCode)"
	ErrGettingSeededComponentsCode        = "meshery-server-1287(ErrGettingSeededComponentsCode)"
	ErrDownloadingSeededComponentsCode    = "meshery-server-1288(ErrDownloadingSeededComponentsCode)"
	ErrContextIDCode                      = "meshery-server-1289(ErrContextIDCode)"
	ErrMesheryInstanceIDCode              = "meshery-server-1290(ErrMesheryInstanceIDCode)"
	ErrMesheryNotInClusterCode            = "meshery-server-1291(ErrMesheryNotInClusterCode)"
	ErrBrokerNotFoundCode                 = "meshery-server-1292(ErrBrokerNotFoundCode)"
	ErrCreateOperatorDeploymentConfigCode = "meshery-server-1293(ErrCreateOperatorDeploymentConfigCode)"
	ErrRequestMeshsyncStoreCode           = "meshery-server-1294(ErrRequestMeshsyncStoreCode)"
	ErrBrokerSubscriptionCode             = "meshery-server-1295(ErrBrokerSubscriptionCode)"
	ErrContextAlreadyPersistedCode        = "meshery-server-1296(ErrContextAlreadyPersistedCode)"
	ErrGetPackageCode                     = "meshery-server-1297(ErrGetPackageCode)"
	ErrTokenRevokeCode                    = "meshery-server-1298(ErrTokenRevokeCode)"
	ErrTokenIntrospectCode                = "meshery-server-1299(ErrTokenIntrospectCode)"
	ErrShareDesignCode                    = "meshery-server-1300(ErrShareDesignCode)"
	ErrUnreachableRemoteProviderCode      = "meshery-server-1301(ErrUnreachableRemoteProviderCode)"
	ErrShareFilterCode                    = "meshery-server-1302(ErrShareFilterCode)"
	ErrPersistEventCode                   = "meshery-server-1303(ErrPersistEventCode)"
	ErrUnreachableKubeAPICode             = "meshery-server-1304(ErrUnreachableKubeAPICode)"
	ErrFlushMeshSyncDataCode              = "meshery-server-1305(ErrFlushMeshSyncDataCode)"
	ErrUpdateConnectionStatusCode         = "meshery-server-1306(ErrUpdateConnectionStatusCode)"
	ErrResultNotFoundCode                 = "meshery-server-1307(ErrResultNotFoundCode)"
	ErrPersistCredentialCode              = "meshery-server-1308(ErrPersistCredentialCode)"
	ErrPersistConnectionCode              = "meshery-server-1309(ErrPersistConnectionCode)"
	ErrPrometheusScanCode                 = "meshery-server-1310(ErrPrometheusScanCode)"
	ErrGrafanaScanCode                    = "meshery-server-1311(ErrGrafanaScanCode)"
	ErrDBCreateCode                       = "meshery-server-1312(ErrDBCreateCode)"
	ErrDoRequestCode                      = "meshery-server-1321(ErrDoRequestCode)"
)
