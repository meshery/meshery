...
type Provider interface {
	...
	GetCatalogMesheryPatterns(tokenString string, page, pageSize, search, order string, includeMetrics string, class []string, technology []string, patternType []string) ([]byte, error)
