...
type Provider interface {
	...
	GetMesheryPatterns(tokenString, page, pageSize, search, order string, updated_after string) ([]byte, error)
	...
	GetMesheryApplications(tokenString, page, pageSize, search, order string, updated_after string) ([]byte, error)
