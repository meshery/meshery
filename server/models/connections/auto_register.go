...
// 			// if connType != "" {
// 			// 	id, _ := uuid.NewV4()
// 			// 	machineInst, err := machines.GetMachine(mm.DISCOVERED, connType, id.String(), arh.log)
// 			// 	if err != nil {
...
// func SetAutoRegistrationHelperSingleton(dbHandler *database.Handler, provider models.Provider) *AutoRegistrationHelper {
// 	defer mutex.Unlock()
// 	mutex.Lock()
