...
type MesheryEvents interface {
	GetAllEvents(eventFilter *events.EventsFilter, userID uuid.UUID, ownerUserID uuid.UUID) (*EventsResponse, error)
	GetEventTypes(userID uuid.UUID, ownerUserID uuid.UUID) (map[string]interface{}, error)
