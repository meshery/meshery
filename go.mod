...
require (
	...
	github.com/go-openapi/runtime v0.27.2 // Downgraded to maintain compatibility with validate v0.23.0 - See #12185
...
require (
	...
	github.com/go-openapi/validate v0.23.0 // indirect; indirect - Downgraded due to build compatibility issues with prometheus client - See #12185
