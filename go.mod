...
replace (
	github.com/go-git/go-git/v5 => github.com/go-git/go-git/v5 v5.4.2 // do not upgrade, due to issues with github.com/cloudflare/circl
...
require (
	...
	github.com/layer5io/meshkit v0.6.22
