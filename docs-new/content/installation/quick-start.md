...
description: Getting Meshery up and running locally on a Docker-enabled system or in Kubernetes is easy. Meshery deploys as a set of Docker containers, which can be deployed to either a Docker host or Kubernetes cluster.
type: installation
weight: 1
---
...
{{< alert title="Quick Start Assumptions" color="warning" >}}
This quick start guide enables you to download, install, and run Meshery in a single command. See all <a href='/installation'>supported platforms</a> for more specific (and less presumptious) instructions.
{{< /alert >}}
...
{{< alert title="Meshery CLI" color="info" >}}
...
{{< alert title="Accessing Meshery Server with Meshery UI" color="light" >}}
...
{{< alert title="Accessing Meshery Server with Meshery CLI" color="light" >}}
...
Select from the list of [Providers](/extensibility/providers) in order to login to Meshery. Authenticate with your chosen Provider.
...
<a href="/assets/img/platforms/k8s-context-switcher.png" alt="Meshery Kubernetes Context Switcher">
  <img class="center" style="width:min(100%,350px);" src="/assets/img/platforms/k8s-context-switcher.png" />
</a>
...
<a href="/assets/img/platforms/meshery-designs.png">
  <img class="center" style="width:min(100%,650px);" src="/assets/img/platforms/meshery-designs.png" />
</a>
...
<div class="section">
    <ul>
        <li><a href="/guides/troubleshooting/installation">Troubleshooting Meshery Installations</a></li>
        <li><a href="/reference/error-codes">Meshery Error Code Reference</a></li>
        <li><a href="/reference/mesheryctl/system/check">mesheryctl system check</a></li> 
    </ul>
</div>
