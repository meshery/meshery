...
![Import redis-leader-deployment](/guides/tutorials/images/screenshots/redis-leader-deployment.png)
...
![merging all designs](/guides/tutorials/images/screenshots/app-canvas.png)

#### 4. **Deploy the files:**

1. Click Actions in the top right corner and click on Deploy.
![Import redis-php-guestbook-deploy](/guides/tutorials/images/screenshots/redis-php-guestbook-deploy.png)

1. The design will be validated to make sure there are no errors.
![Import redis-php-guestbook-validate](/guides/tutorials/images/screenshots/redis-php-guestbook-validate.png)
1. Choose the Kubernetes cluster you want to deploy to.
![Import redis-php-guestbook-identify](/guides/tutorials/images/screenshots/redis-php-guestbook-identify.png)
1. A Dry-Run will be triggered.
![Import redis-php-guestbook-dryrun](/guides/tutorials/images/screenshots/redis-php-guestbook-dryrun.png)
1. Finally your deployment and click Deploy to deploy the application to the cluster.
![Import redis-php-guestbook-finalize](/guides/tutorials/images/screenshots/redis-php-guestbook-finalize.png)
...
![Operate](/guides/tutorials/images/screenshots/operate.png)

2. Click on the Layers option below to view all available filters.
![Operate layers](/guides/tutorials/images/screenshots/operate-layers.png)
Now you can utilize this filter to visualize your design.
![Operate layers expanded](/guides/tutorials/images/screenshots/operate-layers-expand.png)
...
![Operate logs menu](/guides/tutorials/images/screenshots/operate-logs-menu.png)
...
![Operate logs ](/guides/tutorials/images/screenshots/operate-logs.png)
