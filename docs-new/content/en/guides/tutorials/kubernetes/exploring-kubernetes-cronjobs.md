...
description: In this tutorial, we will explore how to use Meshery Playground, an interactive live cluster environment, to perform hands-on labs for managing Kubernetes CronJobs.
aliases:
- /guides/tutorials/exploring-kubernetes-cronjobs
---
...
[![Configuration menu](/guides/tutorials/images/configuration-menu-design-import.png)](/guides/tutorials/images/configuration-menu-design-import.png)
...
[![Click import button](/guides/tutorials/images/click-import.png)](/guides/tutorials/images/click-import.png)
...
[![Design is auto-saved](/guides/tutorials/images/design-auto-save.png)](/guides/tutorials/images/design-auto-save.png)
7. Locate your design and click the deploy button to initiate the deployment process.
[![Located App](/guides/tutorials/images/app-deploy.png)](/guides/tutorials/images/app-deploy.png)
8. Once the popup window opens, wait for the dry run to complete, and then click the deploy button.
[![Dry Run](/guides/tutorials/images/click-deploy.png)](/guides/tutorials/images/click-deploy.png)
9. Upon successful deployment, a confirmation pop-up will appear, indicating that your app has been successfully deployed.
[![Deployment Success](/guides/tutorials/images/deploy-success.png)](/guides/tutorials/images/deploy-success.png)
...
[![CronJob Toolbar](/guides/tutorials/images/toolbar-cronjob.png)](/guides/tutorials/images/toolbar-cronjob.png)
...
[![CronJob Toolbar](/guides/tutorials/images/tool-bar.png)](/guides/tutorials/images/tool-bar.png)
...
[![Deploy CronJob](/guides/tutorials/images/deploy.png)](/guides/tutorials/images/deploy.png)
11. In the pop-up window, review and correct any errors as necessary. Then, click the deploy button.
[![Deploy CronJob](/guides/tutorials/images/deploy-app.png)](/guides/tutorials/images/deploy-app.png)
...
To view the resources created for the CronJob, we will utilize the Visualize tab of the Kanvas. A view will be created with necessary filters to display the relevant resources.
   ...
   [![Vizualize CronJob](/guides/tutorials/images/view.png)](/guides/tutorials/images/view.png)
...
#### 5. **Scaling and Updating CronJobs:**
   ...
   3. Locate the CronJob Component:
        ...
        [![Vizualize CronJob](/guides/tutorials/images/design-cronjob.png)](/guides/tutorials/images/design-cronjob.png)
