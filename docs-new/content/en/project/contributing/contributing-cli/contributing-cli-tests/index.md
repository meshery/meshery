...
description: "Guide to writing and running Meshery CLI tests"
weight: 20
aliases:
  - /project/contributing/contributing-cli-tests
---
...
{{< alert type="info" title="Meshery CLI Reference Documents" >}}
<ul><li><a href="/project/contributing/contributing-cli">Contributing to Meshery CLI</a></li><li><a href="https://docs.google.com/spreadsheets/d/1q63sIGAuCnIeDs8PeM-0BAkNj8BBgPUXhLbe1Y-318o/edit#gid=0">Meshery Command Tracker</a>: Status of mesheryctl command implementation and platform compatibility.</li>
<li><a href="https://docs.google.com/document/d/1xRlFpElRmybJ3WacgPKXgCSiQ2poJl3iCCV1dAalf0k/edit#">Meshery CLI Commands and Documentation</a>: Detailed documentation of the <code>mesheryctl</code> commands.</li>
...
Be aware that some test cases require the availability of a Kubernetes cluster and one or more  Meshery Adapters. In those cases, please refer to the [installation guides](/installation)) (like that of [installing Meshery on Minikube](/installation/kubernetes/minikube)). 
