---
title: CLI
description: "Contributing to Meshery CLI (mesheryctl)"
weight: 30
aliases:
...
{{< alert type="warning" title="Avoid documentation being overwritten" >}}
It is advised not to modify the changes in <code>docs</code> folder, rather should be done in <code>mesheryctl</code> folder as the changes will get overwritten by the CI workflows.
{{< /alert >}}
