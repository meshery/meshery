...
{{< code >}}errors.New(ErrExampleCode, errors.Alert, []string{"<short-description>"}, []string{"<long-description>"}, []string{"<probable-cause>"}, []string{"<suggested remediation>"}){{< /code >}}
## Example
...
{{< code >}}bd, err := json.Marshal(providers)
	if err != nil {
...
{{< code >}}logrus.Debugf("meshLocationURL: %s", meshLocationURL){{< /code >}}

##### New

{{< code >}}l.log.Debug("meshLocationURL: ", meshLocationURL){{< /code >}}

#### Error

##### Old

{{< code >}}logrus.Errorf("error marshaling data: %v.", err){{< /code >}}

##### New

{{< code >}}l.log.Error(ErrMarshal(err, obj)){{< /code >}}
