...
description: "Guide to Meshery UI end-to-end tests"
weight: 30
aliases:
  - /project/contributing/contributing-ui-tests
---
...
{{< alert type="info" title="Accessing Remote Providers" >}}
...
{{< alert type="warning" title="Several Test may break" >}}
...
{{< alert type="warning" title="Playwright Versioning" >}}
Make sure the version you are using matches the version of <code>@playwright/test</code> in the <code>package.json</code> dev dependencies.
{{< /alert >}}
...
{{< alert type="warning" title="Unsafe Environment" >}}
