---
title: UI
description: "Contributing to Meshery UI"
weight: 60
aliases:
...
{{< alert type="info" title="Windows User?" >}}
See <a href='https://docs.meshery.io/project/contributing/meshery-windows'>Setting up Meshery Development Environment on Windows</a>.
{{< /alert >}}
...
<a href="/assets/img/meshery-development-incompatible-error.png">
  <img style= "width: 600px;" src="/assets/img/meshery-development-incompatible-error.png" />
</a>
