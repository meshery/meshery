---
title: Models
description: "Contributing to Meshery Models"
weight: 90
aliases:
  - /project/contributing/contributing-models
---
...
[![Model Entity Classification](/assets/img/meshmodel/meshmodel-architecture.svg)](/assets/img/concepts/meshery-models.png)
...
{{< alert type="info" title="Schema example" >}}
...
{{< alert type="info" title="Definition example" >}}
...
{{< alert type="info" title="Declaration example" >}}
...
{{< alert type="info" title="Instance example" >}}
...
{{< alert type="info" title="Capabilities Schema example" >}}
...
{{< alert type="info" title="CSV Import Only" >}}
...
{{< alert type="info" title="Meshery Models are extensible" >}}
