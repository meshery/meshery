...
Source: /pr-preview/pr-21670/project/releases/v0.5.63-rc-1/
...
- [CI] e2e tests for multiple k8s versions using meshery-performance-action @DelusionalOptimist (#4279)
- use latest version of jsonschema utility in meshery container image @DelusionalOptimist (#4272)
