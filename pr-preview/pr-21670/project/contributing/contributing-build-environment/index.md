...
> Local build and dependency failures in Meshery that report a cause other than their own.

Source: /pr-preview/pr-21670/project/contributing/contributing-build-environment/
...
<pre class="codeblock-pre">
	<div class="codeblock">
		<code class="clipboardjs">env -u GOROOT PATH=&#34;$HOME/.gvm/gos/go1.26.4/bin:$PATH&#34; go test ./...</code>
	</div>
</pre>
...
<pre class="codeblock-pre">
	<div class="codeblock">
		<code class="clipboardjs">which -a sass &amp;&amp; sass --embedded --version</code>
	</div>
</pre>
