...
Source: /pr-preview/pr-21670/project/contributing/contributing-policies/
...
<pre class="codeblock-pre">
	<div class="codeblock">
		<code class="clipboardjs">make policy-test</code>
	</div>
</pre>
...
<pre class="codeblock-pre">
	<div class="codeblock">
		<code class="clipboardjs">make policy-lint</code>
	</div>
</pre>
