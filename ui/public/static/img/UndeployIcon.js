...
const UndeployIcon = (props) => (
  <svg preserveAspectRatio="none" fill={props.fill} viewBox="0 0 24 24" height={props.height || 26 } width={props.width || 26 } xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0zm0 0h24v24H0V0z">
  </path>
