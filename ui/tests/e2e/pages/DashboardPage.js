...
export class DashboardPage {
    ...
    async navigateToConnections() {
        await this.navigateToSubMenuItem(LEFT_NAV.LIFECYCLE.name, LEFT_NAV.LIFECYCLE.NAV_ITEMS.CONNECTIONS);
    }

    async navigateToEnvironment() {
        await this.navigateToSubMenuItem(LEFT_NAV.LIFECYCLE.name, LEFT_NAV.LIFECYCLE.NAV_ITEMS.ENVIRONMENT);
    }

    async navigateToWorkspace() {
        await this.navigateToSubMenuItem(LEFT_NAV.LIFECYCLE.name, LEFT_NAV.LIFECYCLE.NAV_ITEMS.WORKSPACE);
    }

    async navigateToAdapters() {
        await this.navigateToSubMenuItem(LEFT_NAV.LIFECYCLE.name, LEFT_NAV.LIFECYCLE.NAV_ITEMS.ADAPTERS);
    }

    async navigateToProfiles() {
        await this.navigateToSubMenuItem(LEFT_NAV.PERFORMANCE.name, LEFT_NAV.PERFORMANCE.NAV_ITEMS.PROFILES);
    }
