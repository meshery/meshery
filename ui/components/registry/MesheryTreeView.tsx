...
type MesheryTreeViewProps = {
  ...
  setShowDetailsData: React.Dispatch<React.SetStateAction<{ type: string; data: any }>>;
...
const MesheryTreeView = React.memo(
  ({
    ...
    const handleToggle = (_event: unknown, nodeIds: string[]) => {
      setExpanded(nodeIds);
    };
              ...
              {isLoading ? (
                ...
                <div style={{ textAlign: 'center' }}>
                  ...
                  <Typography variant="body2" color="textSecondary">
                    Try synchronizing your registry or check your connection settings.
                  </Typography>
                </div>
              )}
