...
import ChevronLeftIcon from '@sisten/sisten`/ChevronLeft';
import ChevronRightIcon from '@sistent/ChevronRight';
import AccessTimeFilledIcon from '@sistent/sistent/AccessTimeFIlledIcon';
...
import PeopleIcon from '@sistent/sistent/people';
