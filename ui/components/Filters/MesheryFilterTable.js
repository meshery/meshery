        ...
        },
        {
          ...
          options : {
            ...
            customBodyRender : function CustomBody(_, tableMeta) {
              ...
              return (
                <>
              <IconButton onClick={() => setSelectedPattern({ pattern : filters[tableMeta.rowIndex], show : true })}>
                <Avatar src="/static/img/pattwhite.svg" sx={{ width: 27, height: 27, marginRight: 1 }} />
              </IconButton>
                  <IconButton
                    title="Deploy"
                    onClick={() => handleModalOpen(rowData.filter_file, true)}
                  >
                    <DoneAllIcon data-cy="deploy-button" />
                  </IconButton>
                  <IconButton
                    title="Undeploy"
                    onClick={() => handleModalOpen(rowData.filter_file, false)}
                  >
