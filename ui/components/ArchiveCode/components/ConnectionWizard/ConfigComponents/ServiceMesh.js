...
import { configureAdapterWithNotification } from '../../../../../utils/helpers/serviceMeshes';
...
const ServiceMeshConfig = ({ adapterLoc, updateProgress, closeSnackbar, updateAdaptersInfo }) => {
