...
import { fetchContexts, submitConfig } from '../../../../../utils/helpers/kubernetesHelpers';
import { useNotification } from '../../../../../utils/hooks/useNotification';

const KubernetesConfig = ({ updateK8SConfig, updateProgress }) => {
      ...
      if (name === 'k8sfile') {
        ...
        fetchContexts(updateProgress, k8sfile)
          .then((res) => {
            setState({
              ...state,
              contextsFromFile: res.result,
              k8sfile,
              contextNameForForm: res.currentContextName,
            });
