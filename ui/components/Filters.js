  ...
  const handleUndeploy = (filter_file, name) => {
    dataFetch(
      ...
      () => {
        ...
        // });
        notify({
          message : `"${name}" filter undeployed`,
          variant : "success",
          event_type : EVENT_TYPES.SUCCESS
        })
      },
...
// @ts-ignore
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(withNotify(MesheryFilters)));
