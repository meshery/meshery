              ...
              <ul>
                <Typography>
                  <li className={classes.troubleshootListitem}>
                    ...
                    <div className={classes.keyStyleContainer}>E</div> to force reload if
                    you are getting stale copy of the component due to caching.
                  </li>
                  <li className={classes.troubleshootListitem}>
                    Use Incognito or Private browsing mode. If you are still getting stale
                    copy of the component, try opening a <code>incognito tab</code>
                  </li>
                </Typography>
              </ul>
            </AccordionDetails>
              ...
              <ul>
                <Typography>
                  <li className={classes.troubleshootListitem}>
                    ...
                    <code>kubectl get svc -n meshery</code>. Docker Desktop: VPNkit
                    commonly fails to assign an IP address to Meshery Broker (MeshSync).
                    Verify that the Meshery Broker service has external IP address
                    assigned.
                  </li>
                  <li className={classes.troubleshootListitem}>
                    Confirm that your machine&apos;s firewall isn&apos;t getting in the
                    way.
                  </li>
                  <li className={classes.troubleshootListitem}>
            ...
            <AccordionDetails className={classes.accDetailsContainer}>
              ...
              <ul>
                <Typography>
                  ...
                  <li className={classes.troubleshootListitem}>
                    <b>Loading</b>: Confirm that the <code>plugin</code> version offered
                    by Meshery Cloud (at{" "}
                    <a
                    ...
                    ), from which MeshMap files are retreived, matches the{" "}
                    <code>plugin</code> version that Meshery Server is using as the
                    filesystem reference in{" "}
