...
import { DisableButton } from './Registry.style';
...
const MeshModelComponent_ = ({
  ...
  const { selectedTab, searchQuery, selectedPageSize } = useRegistryRouter();
...
export default withStyles(registryStyles)(MeshModelComponent);
