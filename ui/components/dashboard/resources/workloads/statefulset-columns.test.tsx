...
describe('buildStatefulSetColumns', () => {
  it('returns the StatefulSet name and non-empty columns', () => {
    const cfg = buildStatefulSetColumns({
      switchView: () => {},
      meshSyncResources: [],
      k8sConfig: {},
    ...
    expect(cfg.name).toBe('StatefulSet');
