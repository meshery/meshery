...
describe('buildPriorityClassColumns', () => {
  it('returns the PriorityClass name and non-empty columns', () => {
    const cfg = buildPriorityClassColumns({
      switchView: () => {},
      meshSyncResources: [],
      k8sConfig: {},
    ...
    expect(cfg.name).toBe('PriorityClass');
