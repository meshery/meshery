...
describe('buildMutatingWebhookConfigurationColumns', () => {
  it('returns the MutatingWebhookConfiguration name and non-empty columns', () => {
    const cfg = buildMutatingWebhookConfigurationColumns({
      switchView: () => {},
      meshSyncResources: [],
      k8sConfig: {},
      connectionMetadataState: {},
      workloadType: 'MutatingWebhookConfiguration',
      ping: () => {},
    });
    expect(cfg.name).toBe('MutatingWebhookConfiguration');
