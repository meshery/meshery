...
class UserPreference extends React.Component {
  ...
  render() {
    const { anonymousStats, perfResultStats, tabVal, userPrefs, providerType, catalogContent } = this.state;
                      ...
                      <FormControlLabel
                        ...
                        control={
                          <Switch
                            ...
                            color="primary"
                            classes={{ switchBase : classes.switchBase, track : classes.track, checked : classes.checked }}
...
export default withStyles(styles)(
  connect(mapStateToProps, mapDispatchToProps)(withRouter(withSnackbar(UserPreference)))
);
