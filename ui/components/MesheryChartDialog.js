...
const MesheryChartDialog = ({ classes, open, title, handleClose, content }) => {
  return (
    <React.Fragment>
      <Dialog fullWidth maxWidth="md" open={open} onClose={handleClose} aria-labelledby="chart-dialog-title">
