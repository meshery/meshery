...
darkTheme = {
  ...
  overrides : {
    ...
    MuiPaper : { root : { backgroundColor : '#1A1A1A' }, elevation2 : { boxShadow : "0px 4px 0px -2px rgb(0 179 159 / 10%), 0px 4px 0px 0px rgb(0 179 159 / 10%), 0px 2px 0px 0px rgb(0 179 159 / 20%)" } },
