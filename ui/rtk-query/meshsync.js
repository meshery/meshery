      ...
      getMeshSyncResources: builder.query({
        query: (queryArg) => ({
          ...
          params: {
            ...
            status: queryArg.status !== undefined ? queryArg.status : false,
            annotations: queryArg.annotations !== undefined ? queryArg.annotations : false,
            spec: queryArg.spec !== undefined ? queryArg.spec : false,
            labels: queryArg.labels !== undefined ? queryArg.labels : false,
