...
integrationIcon: icons/color/aws-target-group-binding-color.svg
darkModeIntegrationIcon: icons/white/aws-target-group-binding-white.svg
...
"colorIcon": "icons/components/target-group-binding/icons/color/target-group-binding-color.svg",
"whiteIcon": "icons/components/target-group-binding/icons/white/target-group-binding-white.svg",
"description": "",
}]
featureList: [
