...
integrationIcon: icons/color/karpenter-color.svg
darkModeIntegrationIcon: icons/white/karpenter-white.svg
...
"colorIcon": "icons/components/aws-node-template/icons/color/aws-node-template-color.svg",
"whiteIcon": "icons/components/aws-node-template/icons/white/aws-node-template-white.svg",
"description": "",
},
{
"name": "provisioner",
