...
integrationIcon: icons/color/aws-load-balancer-controller-color.svg
darkModeIntegrationIcon: icons/white/aws-load-balancer-controller-white.svg
...
"colorIcon": "icons/components/ingress-class-params/icons/color/ingress-class-params-color.svg",
"whiteIcon": "icons/components/ingress-class-params/icons/white/ingress-class-params-white.svg",
"description": "",
}]
featureList: [
