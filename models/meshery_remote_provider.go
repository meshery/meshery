...
func (l *MesheryRemoteProvider) PublishResults(req *http.Request, data []byte) (string, error) {
...
func (l *MesheryRemoteProvider) PublishMetrics(tokenVal string, data []byte) error {
