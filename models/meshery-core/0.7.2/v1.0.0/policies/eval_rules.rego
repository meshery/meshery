...
same_relationship_selector_clause(clause_a, clause_b) if {
...
relationship_already_exists(design_file, relationship) if {
...
match_values(from_value, to_value, strategy) if {
	strategy == "equal"
	from_value == to_value
}
...
match_values_with_strategies(from_value, to_value, strategies) if {
...
from_and_to_components_exist(relationship, design_file) if {
...
from_or_to_components_dont_exist(relationship, design_file) if {
