...
GitHub organization membership (with `triage` access to all repos) is separate from contributor status. Community members who wish to become members of the organization should meet the following requirements, which are open to the discretion of the steering committee:
