...
valid_namespaces=("kube-system" "default" "monitoring" "kube-flannel" "kube-node-lease" "kube-public" "meshery" "metallb-system" "projectcontour" "ingress-nginx" "layer5-cloud" "postgres" "staging-fullstack" "cnpg" "cnpg-system" "cnpg-postgres" "cloud" "layer5" "local-path-storage")
