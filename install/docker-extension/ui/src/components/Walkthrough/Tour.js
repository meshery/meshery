...
const TOUR_STEPS = [
  {
    ...
    content: (
      <i>
        A Catalog is a web-based, public catalog to facilitate easy sharing and
  ...
  },
  {
    ...
    content: (
      <i>
        Import your Docker Compose apps. Configure and deploy them to Kubernetes
        and any service mesh.
      </i>
    ),
  },
  {
    ...
    content: (
      <i>
        Launch Meshery to visualize and design your Docker Compose applications,
        run performance tests and much more.
      </i>
    ),
  },
];
