...
@test "[cut=Model][tg=Model Generate] mesheryctl model generate displays usage instructions when no file, filePath or URL is provided" {
...
@test "[cut=Model][tg=Model Generate] mesheryctl model generate fails with invalid URL" {
    run $MESHERYCTL_BIN model generate --file "invalid-url"
    assert_failure
    assert_output --partial "invalid URL"
}

@test "[cut=Model][tg=Model Generate] mesheryctl model generate succeeds with valid URL and template" {
...
@test "[cut=Model][tg=Model Generate] mesheryctl model generate fails with missing template for URL" {
    run $MESHERYCTL_BIN model generate --file "$FIXTURES_DIR/valid-model"
    assert_failure
    assert_output --partial "Template file is not present"
}

@test "[cut=Model][tg=Model Generate] mesheryctl model generate succeeds with valid CSV directory" {
...
@test "[cut=Model][tg=Model Generate] mesheryctl model generate fails with invalid CSV directory" {
    run $MESHERYCTL_BIN model generate --file "invalid-dir"
    assert_failure
    assert_output --partial "error reading file"
}

@test "[cut=Model][tg=Model Generate] mesheryctl model generate skips registration with --register flag" {
