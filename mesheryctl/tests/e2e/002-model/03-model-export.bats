...
@test "mesheryctl model export succeeds with default options" {
  ...
  assert_output --partial "api/meshmodels/export?name=$TESTDATA_DIR"
  assert_output --partial "output_format=yaml"
  assert_output --partial "file_type=oci"
  assert_output --partial "components=true"
  assert_output --partial "relationships=true"
}
