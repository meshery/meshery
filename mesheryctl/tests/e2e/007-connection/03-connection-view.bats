...
@test "given a valid argument is provided as an argument when running mesheryctl connection view connection-id --output-format json/yaml then a details in default format is displayed according to choice" {
    require_connection_id
