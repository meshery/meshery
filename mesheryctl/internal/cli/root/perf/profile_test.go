...
var (
	...
	// html output for not authenticated
...
var (
	...
	// mesheryctl response for no authentication
...
func TestProfileCmd(t *testing.T) {
	...
	testsWithOutputFormat := []profileTestStruct{
	...
	testsForErrors := []profileTestStruct{
		{"invalid output format", []string{"profile", "-o", "invalid"}, []utils.MockURL{{"GET", profileURL, profile1001, 200}}, profile1008output, profileURL, true},
		{"not authenticated", []string{"profile"}, []utils.MockURL{{"GET", profileURL, profile1005, 200}}, profile1009output, testToken, true},
		{"Server Error 500", []string{"profile"}, []utils.MockURL{{"GET", profileURL, profile1006, 500}}, profile1010output, testToken, true},
		{"Unmarshal error", []string{"profile"}, []utils.MockURL{{"GET", profileURL, profile1006, 200}}, profile1011output, testToken, true},
		{"failing add authentication test", []string{"profile"}, []utils.MockURL{}, profile1012output, "testToken", true},
	}
