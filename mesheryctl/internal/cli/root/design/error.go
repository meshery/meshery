...
const (
	...
	// TODO update erros codes after mergig the perf PR
	ErrParseDesignFileCode            = "replace_me"
	ErrDeleteDesignCode               = "replace_me"
	ErrInvalidCMDCode                 = "replace_me"
	ErrDesignNameOrIDNotSpecifiedCode = "replace_me"
)
