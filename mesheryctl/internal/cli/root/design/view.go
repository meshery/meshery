...
var linkDocDesignView = map[string]string{
	"link":    "![design-view-usage](/assets/img/mesheryctl/designView.png)",
...
mesheryctl design view [design-name | ID]
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if isID {
			...
			if body, err = json.MarshalIndent(map[string]interface{}{"design": dat["patterns"]}, "", "  "); err != nil {
				utils.Log.Error(utils.ErrMarshalIndent(err))
				return nil
			}
		} else {
