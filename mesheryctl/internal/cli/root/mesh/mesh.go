...
var (
	...
	MeshCmd    = &cobra.Command{
		...
		Long:  "Provisioning, configuration, and on-going operational management of service meshes. Find more information at: https://docs.meshery.io/reference/mesheryctl#command-reference",
