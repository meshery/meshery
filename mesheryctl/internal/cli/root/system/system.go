...
var SystemCmd = &cobra.Command{
	...
	Long:  `Manage the state and configuration of Meshery server, components, and client. Find more information at: https://docs.meshery.io/reference/mesheryctl#command-reference`,
