...
var linkDocContextCreate = map[string]string{
	"link":    "![context-create-usage](/reference/reference/images/newcontext.png)",
...
var linkDocContextView = map[string]string{
	"link":    "![context-view-usage](/reference/reference/images/context-view.png)",
...
var linkDocContextSwitch = map[string]string{
	"link":    "![context-switch-usage](/reference/reference/images/contextswitch.png)",
