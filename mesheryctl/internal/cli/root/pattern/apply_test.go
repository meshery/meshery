...
func TestApplyCmd(t *testing.T) {
    ...
    tests := []struct {
...

        {
            ...
            Args:             []string{"apply", "-f", "https://raw.githubusercontent.com/meshery/meshery/master/mesheryctl/internal/cli/root/pattern/fixtures/pattern.golden"},
            ExpectedResponse: "apply.url.output.golden",
            URLs: []utils.MockURL{
                {
                    Method:       "GET",
                    URL:          "https://raw.githubusercontent.com/meshery/meshery/master/mesheryctl/internal/cli/root/pattern/fixtures/pattern.golden",
