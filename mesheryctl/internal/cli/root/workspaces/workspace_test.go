...
func TestWorkspaces(t *testing.T) {
	...
	tests := []utils.MesheryListCommandTest{
		...
		},
		{
			...
			ExpectError:      true,
			IsOutputGolden:   false,
			ExpectedError:    utils.ErrInvalidArgument(fmt.Errorf("'%s' is an invalid subcommand. Please provide required options from [create, list, update, view]. Use 'mesheryctl workspace --help' to display usage guide", "invalidCommand")),
		},
	}
