...
// NeedsMutation determines whether the Meshery config file needs to be
// created or updated by checking if it exists, is non-empty, and accessible.
// It returns true when the file is missing or empty, false otherwise, and
// an error if the file cannot be accessed.
...
func InitDefaultConfig(
	...
	if err := os.MkdirAll(mesheryFolder, 0o700); err != nil {
		return ErrCreateMesheryDir(err)
	}
