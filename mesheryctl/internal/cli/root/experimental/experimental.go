...
import (
	...
	"github.com/layer5io/meshery/mesheryctl/internal/cli/root/orgs"
...
func init() {
	availableSubcommands = append(availableSubcommands, connections.ConnectionsCmd, relationships.RelationshipCmd, workspaces.WorkSpaceCmd, orgs.OrgCmd, model.ModelExpCmd)
