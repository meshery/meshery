...
import (
	...
	"github.com/layer5io/meshery/mesheryctl/internal/cli/root/application"
...
func init() {
	availableSubcommands = []*cobra.Command{mesh.MeshCmd, filter.FilterCmd, application.ApplicationCmd}
