...
import (
	...
	"github.com/layer5io/meshery/mesheryctl/internal/cli/root/system/components"
...
func init() {
	availableSubcommands = append(availableSubcommands, system.ModelCmd, components.ComponentsCmd, models.ModelCmd)
