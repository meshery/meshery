...
import (
	...
	registry "github.com/layer5io/meshery/mesheryctl/internal/cli/root/registry"
...
func init() {
	availableSubcommands = append(availableSubcommands, system.ModelCmd, registry.PublishCmd)
