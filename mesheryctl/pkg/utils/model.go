...
// func InvokeGenerationFromSheet(wg *sync.WaitGroup, modelName string, modelCSVHelper *ModelCSVHelper, componentCSVHelper *ComponentCSVHelper, tempDir string) error {
...
// 	go func() {
// 		defer wgForSpreadsheetUpdate.Done()
...
// 				err = GenerateDefsForCoreRegistrant(model, componentCSVHelper, tempDir)
// 				if err != nil {
...
// 			}
// 			version := pkg.GetVersion()
// 			modelDirPath, compDirPath, err := createVersionedDirectoryForModelAndComp(version, model.Model, tempDir)
// 			if err != nil {
// 				return
// 			}
...
// func GenerateDefsForCoreRegistrant(model ModelCSV, ComponentCSVHelper *ComponentCSVHelper, tempDir string) error {
// 	var version string
