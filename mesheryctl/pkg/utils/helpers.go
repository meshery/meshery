...
const (
	...
	designListURL                 = docsBaseURL + "reference/mesheryctl/design/list"
	designDeleteURL               = docsBaseURL + "reference/mesheryctl/design/delete"
	designApplyURL                = docsBaseURL + "reference/mesheryctl/design/apply"
...
const (
	...
	cmdDesign                   cmdType = "pattern"
	cmdDesignView               cmdType = "pattern view"
	cmdDesignList               cmdType = "pattern list"
	cmdDesignDelete			    cmdType = "pattern delete"
	cmdDesignApply			    cmdType = "pattern apply"
	cmdApp                      cmdType = "app"
