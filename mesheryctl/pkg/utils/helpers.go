...
var Services = map[string]Service{
	"meshery": {
		...
		Environment: []string{
			"PROVIDER_BASE_URLS=https://cloud.meshery.io,https://cloud.layer5.io,https://meshery.digitalocean.com,https://idp.cleverluck.com,https://designer.exoscale.com,https://perf.platorm.intel.com,https://ppf.research.utexas.edu,https://tcs-labs.in", // AUTO-GENERATED-FROM-MAKEFILE - edit install/Makefile.core.mk then run make sync-provider-defaults
