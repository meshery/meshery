...
var Services = map[string]Service{
	"meshery": {
		...
		Environment: []string{
			"PROVIDER_BASE_URLS=https://cloud.meshery.io,https://cloud.layer5.io", // AUTO-GENERATED-FROM-MAKEFILE - edit install/Makefile.core.mk then run make sync-provider-defaults
